var Zr=Object.defineProperty;var el=(o,c,f)=>c in o?Zr(o,c,{enumerable:!0,configurable:!0,writable:!0,value:f}):o[c]=f;var it=(o,c,f)=>el(o,typeof c!="symbol"?c+"":c,f);(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const k of document.querySelectorAll('link[rel="modulepreload"]'))C(k);new MutationObserver(k=>{for(const N of k)if(N.type==="childList")for(const j of N.addedNodes)j.tagName==="LINK"&&j.rel==="modulepreload"&&C(j)}).observe(document,{childList:!0,subtree:!0});function f(k){const N={};return k.integrity&&(N.integrity=k.integrity),k.referrerPolicy&&(N.referrerPolicy=k.referrerPolicy),k.crossOrigin==="use-credentials"?N.credentials="include":k.crossOrigin==="anonymous"?N.credentials="omit":N.credentials="same-origin",N}function C(k){if(k.ep)return;k.ep=!0;const N=f(k);fetch(k.href,N)}})();function Jn(){}function Vs(o){return o()}function As(){return Object.create(null)}function di(o){o.forEach(Vs)}function $s(o){return typeof o=="function"}function Pa(o,c){return o!=o?c==c:o!==c||o&&typeof o=="object"||typeof o=="function"}function nl(o){return Object.keys(o).length===0}const tl=typeof window<"u"?window:typeof globalThis<"u"?globalThis:global;function T(o,c){o.appendChild(c)}function on(o,c,f){o.insertBefore(c,f||null)}function Xe(o){o.parentNode&&o.parentNode.removeChild(o)}function U(o){return document.createElement(o)}function Hs(o){return document.createElementNS("http://www.w3.org/2000/svg",o)}function Ra(o){return document.createTextNode(o)}function oe(){return Ra(" ")}function bt(o,c,f,C){return o.addEventListener(c,f,C),()=>o.removeEventListener(c,f,C)}function il(o){return function(c){return c.preventDefault(),o.call(this,c)}}function y(o,c,f){f==null?o.removeAttribute(c):o.getAttribute(c)!==f&&o.setAttribute(c,f)}function al(o){let c;return{p(...f){c=f,c.forEach(C=>o.push(C))},r(){c.forEach(f=>o.splice(o.indexOf(f),1))}}}function sl(o){return Array.from(o.childNodes)}function ol(o,c){c=""+c,o.data!==c&&(o.data=c)}function Pt(o,c){o.value=c??""}class rl{constructor(c=!1){it(this,"is_svg",!1);it(this,"e");it(this,"n");it(this,"t");it(this,"a");this.is_svg=c,this.e=this.n=null}c(c){this.h(c)}m(c,f,C=null){this.e||(this.is_svg?this.e=Hs(f.nodeName):this.e=U(f.nodeType===11?"TEMPLATE":f.nodeName),this.t=f.tagName!=="TEMPLATE"?f:f.content,this.c(c)),this.i(C)}h(c){this.e.innerHTML=c,this.n=Array.from(this.e.nodeName==="TEMPLATE"?this.e.content.childNodes:this.e.childNodes)}i(c){for(let f=0;f<this.n.length;f+=1)on(this.t,this.n[f],c)}p(c){this.d(),this.h(c),this.i(this.a)}d(){this.n.forEach(Xe)}}let ci;function li(o){ci=o}function ll(){if(!ci)throw new Error("Function called outside component initialization");return ci}function cl(o){ll().$$.on_mount.push(o)}const Mt=[],Ts=[];let Rt=[];const Ls=[],dl=Promise.resolve();let Aa=!1;function pl(){Aa||(Aa=!0,dl.then(Fs))}function Ta(o){Rt.push(o)}const Ea=new Set;let Tt=0;function Fs(){if(Tt!==0)return;const o=ci;do{try{for(;Tt<Mt.length;){const c=Mt[Tt];Tt++,li(c),ul(c.$$)}}catch(c){throw Mt.length=0,Tt=0,c}for(li(null),Mt.length=0,Tt=0;Ts.length;)Ts.pop()();for(let c=0;c<Rt.length;c+=1){const f=Rt[c];Ea.has(f)||(Ea.add(f),f())}Rt.length=0}while(Mt.length);for(;Ls.length;)Ls.pop()();Aa=!1,Ea.clear(),li(o)}function ul(o){if(o.fragment!==null){o.update(),di(o.before_update);const c=o.dirty;o.dirty=[-1],o.fragment&&o.fragment.p(o.ctx,c),o.after_update.forEach(Ta)}}function ml(o){const c=[],f=[];Rt.forEach(C=>o.indexOf(C)===-1?c.push(C):f.push(C)),f.forEach(C=>C()),Rt=c}const Bi=new Set;let fl;function La(o,c){o&&o.i&&(Bi.delete(o),o.i(c))}function Ns(o,c,f,C){if(o&&o.o){if(Bi.has(o))return;Bi.add(o),fl.c.push(()=>{Bi.delete(o)}),o.o(c)}}function Ms(o){o&&o.c()}function Na(o,c,f){const{fragment:C,after_update:k}=o.$$;C&&C.m(c,f),Ta(()=>{const N=o.$$.on_mount.map(Vs).filter($s);o.$$.on_destroy?o.$$.on_destroy.push(...N):di(N),o.$$.on_mount=[]}),k.forEach(Ta)}function Ma(o,c){const f=o.$$;f.fragment!==null&&(ml(f.after_update),di(f.on_destroy),f.fragment&&f.fragment.d(c),f.on_destroy=f.fragment=null,f.ctx=[])}function gl(o,c){o.$$.dirty[0]===-1&&(Mt.push(o),pl(),o.$$.dirty.fill(0)),o.$$.dirty[c/31|0]|=1<<c%31}function Ba(o,c,f,C,k,N,j=null,m=[-1]){const G=ci;li(o);const q=o.$$={fragment:null,ctx:[],props:N,update:Jn,not_equal:k,bound:As(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(c.context||(G?G.$$.context:[])),callbacks:As(),dirty:m,skip_bound:!1,root:c.target||G.$$.root};j&&j(q.root);let re=!1;if(q.ctx=f?f(o,c.props||{},(J,de,...me)=>{const Re=me.length?me[0]:de;return q.ctx&&k(q.ctx[J],q.ctx[J]=Re)&&(!q.skip_bound&&q.bound[J]&&q.bound[J](Re),re&&gl(o,J)),de}):[],q.update(),re=!0,di(q.before_update),q.fragment=C?C(q.ctx):!1,c.target){if(c.hydrate){const J=sl(c.target);q.fragment&&q.fragment.l(J),J.forEach(Xe)}else q.fragment&&q.fragment.c();c.intro&&La(o.$$.fragment),Na(o,c.target,c.anchor),Fs()}li(G)}class Da{constructor(){it(this,"$$");it(this,"$$set")}$destroy(){Ma(this,1),this.$destroy=Jn}$on(c,f){if(!$s(f))return Jn;const C=this.$$.callbacks[c]||(this.$$.callbacks[c]=[]);return C.push(f),()=>{const k=C.indexOf(f);k!==-1&&C.splice(k,1)}}$set(c){this.$$set&&!nl(c)&&(this.$$.skip_bound=!0,this.$$set(c),this.$$.skip_bound=!1)}}const hl="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(hl);const bl=`{
  "id": "apis",
  "title": "API Styles",
...
`,Ps="blockscape:apicurioConfig",_a="http://localhost:8080/apis/registry/v3",Mi="bs",Rs="-series",Ia=!1,xa=!1;function jl({models:o,getActiveIndex:c,setActive:f,ensureModelMetadata:C,ensureSeriesId:k,getModelId:N,getSeriesId:j,getModelTitle:m,computeJsonFingerprint:G,uid:q}){let re=null,J=null,de=null,me=null,Re=null,$=null,W=null,Z=null,F=null,X=null;const Se=new Set,P={baseUrl:_a,groupId:Mi,authToken:"",enabled:Ia,useSemver:xa},pe=new Map,fe=new Map;function te(l){return(l||"").toString().trim().replace(/\/+$/,"")}function le(l){return`${(l||"").toString().trim()||Mi}${Rs}`}function we(){return!!(P.baseUrl&&P.groupId)}function ge(){return P.enabled!==!1}function ve(){Se.forEach(l=>{try{l(ge())}catch(u){console.warn("[Blockscape] failed to run Apicurio enabled listener",u)}})}function en(l){return typeof l=="function"&&Se.add(l),()=>Se.delete(l)}function je(){de&&(de.value=P.baseUrl||""),me&&(me.value=P.groupId||""),Re&&(Re.value=P.authToken||""),$&&($.checked=ge()),W&&(W.checked=!!P.useSemver)}function R(l="",u="muted"){Z&&(Z.textContent=l||"",Z.classList.remove("is-error","is-success"),u==="error"?Z.classList.add("is-error"):u==="success"&&Z.classList.add("is-success"))}function Q(l){if(!X||(X.innerHTML="",!l))return;const u=document.createElement("p");u.className="apicurio-hint",u.textContent=l,X.appendChild(u)}function Ve(l){pe.clear(),fe.clear(),Q(l)}function Be(){const l=c(),u=ge(),_=we(),E=l>=0?o[l]:null,h=!!(E!=null&&E.apicurioVersions&&E.apicurioVersions.length>1);if(re){const M=re.dataset.loading==="true",H=u&&_&&l>=0&&!!Ke(o[l]);re.disabled=!u||M||!H,u?M||(re.textContent="Push to Apicurio"):re.textContent="Enable Apicurio to push"}if(F){const M=F.dataset.loading==="true",H=u&&_&&h&&!!Ke(E);F.disabled=!H||M,F.hidden=!h,u?M||(F.textContent="Push series"):F.textContent="Enable Apicurio to push series"}if(J){const M=J.dataset.loading==="true",H=u&&_;J.disabled=!H||M,M||(u?_?J.textContent="List artifacts":J.textContent="Enter details to list":J.textContent="Enable Apicurio to list")}}function $e(){je(),ge()?we()?(R("Apicurio push is ready when a model is selected.","muted"),pe.size||Q("Click “List artifacts” to browse the current group.")):(R("Enter Apicurio connection details to enable push.","muted"),Ve("Enter registry details to browse artifacts.")):(R("Apicurio integration is off. Enable it to allow pushes.","muted"),Ve("Apicurio integration is disabled.")),Be()}function qe(){if(window!=null&&window.localStorage)try{localStorage.setItem(Ps,JSON.stringify(P))}catch(l){console.warn("[Blockscape] unable to persist Apicurio settings",l)}}function Ae(){let l={};if(window!=null&&window.localStorage)try{const M=localStorage.getItem(Ps);if(M){const H=JSON.parse(M);H&&typeof H=="object"&&(l=H)}}catch(M){console.warn("[Blockscape] failed to restore Apicurio settings",M)}const u=te(l.baseUrl??_a),_=(l.groupId??Mi).toString().trim();let E=Ia,h=xa;typeof l.enabled=="boolean"?E=l.enabled:typeof l.enabled=="string"&&(E=l.enabled==="true"),typeof l.useSemver=="boolean"?h=l.useSemver:typeof l.useSemver=="string"&&(h=l.useSemver==="true"),P.baseUrl=u||_a,P.groupId=_||Mi,P.authToken=(l.authToken??"").toString().trim(),P.enabled=E,P.useSemver=h,$e(),ve()}function We(){const l={Accept:"application/json"},u=(P.authToken||"").trim();return u&&(l.Authorization=/\s/.test(u)?u:`Bearer ${u}`),l}function S(l,u,{title:_,description:E,version:h}={}){const M={artifactId:l,artifactType:"JSON",firstVersion:{content:{contentType:"application/json",content:u},metadata:{properties:{}}}};h&&(M.firstVersion.version=h),_&&(M.name=_),E&&(M.description=E);try{const H=JSON.parse(u),B=H==null?void 0:H.seriesId;B&&typeof B=="string"&&(M.firstVersion.metadata.properties.seriesId=B)}catch{}return M}function w(l,{version:u}={}){const _={content:{contentType:"application/json",content:l},metadata:{properties:{}}};try{const E=JSON.parse(l),h=E==null?void 0:E.seriesId;h&&typeof h=="string"&&(_.metadata.properties.seriesId=h)}catch{}return u&&(_.version=u),_}function Ge(l){if(l==null)return null;const u=String(l).trim();if(!u)return null;const _=/^v?(\d+)\.(\d+)\.(\d+)(?:-.+)?$/.exec(u);if(_)return{major:Number(_[1]),minor:Number(_[2]),patch:Number(_[3])};const E=/^v?(\d+)$/.exec(u);return E?{major:Number(E[1]),minor:0,patch:0}:null}function _e(l){return`${l.major}.${l.minor}.${l.patch}`}function V(l,u){return!l&&!u?0:l?u?l.major!==u.major?l.major-u.major:l.minor!==u.minor?l.minor-u.minor:l.patch-u.patch:1:-1}function be(l=[]){let u=null;if(l.forEach(E=>{const h=Ge((E==null?void 0:E.version)??E);h&&(!u||V(h,u)>0)&&(u=h)}),!u)return"1.0.0";const _={...u,patch:u.patch+1};return _e(_)}function Ke(l,{seriesName:u,fallbackTitle:_}={}){var M;if(!l)return null;const E=u||l.title||l.apicurioArtifactName||m(l),h=_||E;if(typeof k=="function"&&(l.isSeries||((M=l.apicurioVersions)==null?void 0:M.length)>1)&&k(l,{seriesName:E,fallbackTitle:h}),typeof j=="function"){const H=j(l,{seriesName:E,fallbackTitle:h});if(H)return H}return N(l)}function L(l){return Array.isArray(l)?l:Array.isArray(l==null?void 0:l.artifacts)?l.artifacts:Array.isArray(l==null?void 0:l.items)?l.items:Array.isArray(l==null?void 0:l.results)?l.results:[]}function z(l){return Array.isArray(l)?l:Array.isArray(l==null?void 0:l.versions)?l.versions:Array.isArray(l==null?void 0:l.items)?l.items:[]}function ne(l=[]){if(!Array.isArray(l)||!l.length)return null;const u=[...l].filter(Boolean);return u.sort((_,E)=>{const h=_!=null&&_.createdOn?new Date(_.createdOn).getTime():0,M=E!=null&&E.createdOn?new Date(E.createdOn).getTime():0;if(h!==M)return M-h;const H=Number(_==null?void 0:_.version),B=Number(E==null?void 0:E.version),ae=Number.isFinite(H),Y=Number.isFinite(B);if(ae&&Y&&H!==B)return B-H;const ee=String((_==null?void 0:_.version)??"");return String((E==null?void 0:E.version)??"").localeCompare(ee,void 0,{numeric:!0})}),u[0]||null}function he(l){if(!l)return l;let u=l;if(!Array.isArray(l==null?void 0:l.categories)){const E=l==null?void 0:l.content;if(typeof E=="string")try{u=JSON.parse(E)}catch(h){console.warn("[Blockscape] artifact payload contained string content that could not be parsed",h)}else E&&typeof E=="object"&&(u=E)}return u}async function pn(l,u,_){const E=encodeURIComponent(u),h=encodeURIComponent(_),M=`${l}/groups/${E}/artifacts/${h}`,H=We();H.Accept="application/json";const B=await fetch(M,{method:"GET",headers:H});if(!B.ok){let ae=B.statusText||"Unknown error";try{const Y=await B.text();Y&&(ae=Y.slice(0,400))}catch{}throw new Error(`Failed to fetch artifact metadata (${B.status}): ${ae}`)}return B.json()}async function hn(l,u,_){const E=encodeURIComponent(u),h=encodeURIComponent(_),M=`${l}/groups/${E}/artifacts/${h}/versions?limit=50&order=desc`,H=We();H.Accept="application/json";const B=await fetch(M,{method:"GET",headers:H});if(!B.ok){let Y=B.statusText||"Unknown error";try{const ee=await B.text();ee&&(Y=ee.slice(0,400))}catch{}throw new Error(`Failed to fetch artifact versions (${B.status}): ${Y}`)}const ae=await B.json();return z(ae).filter(Y=>Y&&Y.version!=null)}async function un(l,u,_,E="latest"){const h=encodeURIComponent(u),M=encodeURIComponent(_),H=encodeURIComponent(E||"latest"),B=`${l}/groups/${h}/artifacts/${M}/versions/${H}/content`,ae=We();ae.Accept="application/json, application/*+json, */*;q=0.8";const Y=await fetch(B,{method:"GET",headers:ae});if(!Y.ok){let He=Y.statusText||"Unknown error";try{const se=await Y.text();se&&(He=se.slice(0,400))}catch{}throw new Error(`Failed to load artifact content (${Y.status}): ${He}`)}const ee=await Y.text();let ke=null;try{ke=JSON.parse(ee)}catch{throw new Error("Artifact content is not valid JSON.")}return he(ke)}async function De(l,u,_,E="latest"){const h=await un(l,u,_,E);return{data:h,fingerprint:G(h)}}async function On(l,u,_){try{const h=await hn(l,u,_);if(h!=null&&h.length){fe.set(_,h);const M=ne(h);if((M==null?void 0:M.version)!=null)return M.version}}catch(h){console.warn("[Blockscape] compare-version: unable to fetch versions list",h)}try{const h=await pn(l,u,_);if((h==null?void 0:h.version)!=null)return h.version}catch(h){console.warn("[Blockscape] compare-version: unable to fetch metadata",h)}const E=fe.get(_);if(E&&E.length){const h=ne(E);if((h==null?void 0:h.version)!=null)return h.version}return"latest"}async function Ye(l,u,_,E){if(!P.useSemver)return null;if(!E)return"1.0.0";try{const h=await hn(l,u,_);return be(h)}catch(h){throw new Error(`Unable to compute next semantic version: ${h.message}`)}}function ie(l=document){re=l.querySelector("#pushApicurio")||document.getElementById("pushApicurio"),F=l.querySelector("#pushApicurioSeries")||document.getElementById("pushApicurioSeries"),J=l.querySelector("#listApicurioArtifacts")||document.getElementById("listApicurioArtifacts"),de=l.querySelector("#apicurioUrl")||document.getElementById("apicurioUrl"),me=l.querySelector("#apicurioGroup")||document.getElementById("apicurioGroup"),Re=l.querySelector("#apicurioToken")||document.getElementById("apicurioToken"),$=l.querySelector("#apicurioToggle")||document.getElementById("apicurioToggle"),W=l.querySelector("#apicurioSemver")||document.getElementById("apicurioSemver"),Z=l.querySelector("#apicurioStatus")||document.getElementById("apicurioStatus"),X=l.querySelector("#apicurioArtifacts")||document.getElementById("apicurioArtifacts")}function Ne(){P.baseUrl=te((de==null?void 0:de.value)??P.baseUrl),P.groupId=((me==null?void 0:me.value)??"").trim(),P.authToken=((Re==null?void 0:Re.value)??"").trim(),qe(),$e()}function Bt(l){P.enabled=l!==!1,qe(),$e(),ve()}function pi(){Bt($?$.checked:Ia)}function Fn(){P.useSemver=W?W.checked:xa,qe(),$e()}function bn(){[de,me,Re].forEach(l=>{l&&l.addEventListener("input",Ne)}),re&&re.addEventListener("click",()=>{st()}),F&&F.addEventListener("click",()=>{Dt()}),$&&$.addEventListener("change",pi),W&&W.addEventListener("change",Fn),J&&J.addEventListener("click",ot),X&&X.addEventListener("click",l=>{const u=l.target.closest("[data-artifact-version]");if(u){l.stopPropagation();const h=u.dataset.artifactId,M=u.dataset.artifactVersion;h&&M&&zn(h,M);return}const _=l.target.closest("[data-artifact-load-all]");if(_){l.stopPropagation(),_.dataset.artifactId&&Ot();return}const E=l.target.closest("[data-artifact-trigger]");if(E){const h=E.dataset.artifactId;if(!h)return;jn(h)}})}function Un(){const l=document.createElement("div");return l.className="blockscape-registry-panel",l.innerHTML=`
    ...
    `,l}function vn(l){if(!l)return;l.innerHTML="";const u=Un();l.appendChild(u),ie(l),bn(),$e()}function Cn(l){if(!X)return;if(X.innerHTML="",!l.length){Q("No artifacts found in this group.");return}const u=h=>{const M=document.createElement("section");M.className="apicurio-artifact-section";const H=document.createElement("h3");H.textContent=h,M.appendChild(H);const B=document.createElement("ul");return B.className="apicurio-artifact-list",M.appendChild(B),{section:M,list:B}},_=u("Series artifacts"),E=u("Artifacts");l.forEach(h=>{if(!(h!=null&&h.artifactId))return;const H=h._groupId&&h._groupId.endsWith(Rs)?_.list:E.list,B=document.createElement("li"),ae=document.createElement("button");ae.type="button",ae.className="apicurio-artifact",ae.dataset.artifactId=h.artifactId,ae.dataset.artifactTrigger="toggle";const Y=document.createElement("span");Y.className="apicurio-artifact-title",Y.textContent=h.artifactId,ae.appendChild(Y);const ee=[];if(h.name&&ee.push(h.name),h.version!=null&&ee.push(`v${h.version}`),h.type&&ee.push(h.type),h._groupId&&ee.push(h._groupId),ee.length){const se=document.createElement("span");se.className="apicurio-artifact-meta",se.textContent=ee.join(" • "),ae.appendChild(se)}if(h.description){const se=document.createElement("span");se.className="apicurio-artifact-meta",se.textContent=h.description,ae.appendChild(se)}B.appendChild(ae);const ke=document.createElement("div");ke.className="apicurio-version-list",ke.dataset.versionPanel=h.artifactId,ke.hidden=!0;const He=document.createElement("p");He.className="apicurio-hint",He.textContent="Click to load the latest or open versions.",ke.appendChild(He),B.appendChild(ke),H.appendChild(B)}),_.list.children.length&&X.appendChild(_.section),E.list.children.length&&X.appendChild(E.section)}function yn(l){return X?X.querySelector(`[data-version-panel="${l}"]`):null}function En(l,u){if(!l||(l.innerHTML="",!u))return;const _=document.createElement("p");_.className="apicurio-hint",_.textContent=u,l.appendChild(_)}function yt(l,u){const _=yn(l);if(_){if(_.innerHTML="",!u.length){En(_,"No versions found for this artifact.");return}u.forEach(E=>{const h=document.createElement("button");h.type="button",h.className="apicurio-version-button",h.dataset.artifactId=l,h.dataset.artifactVersion=E.version;const M=[`Version ${E.version}`];if(E.createdOn){const H=new Date(E.createdOn);isNaN(H)||M.push(H.toISOString().slice(0,10))}h.textContent=M.join(" — "),_.appendChild(h)})}}async function jn(l){const u=yn(l);if(!u)return;if(u.dataset.open==="true"){u.hidden=!0,u.dataset.open="false";return}if(u.hidden=!1,u.dataset.open="true",u.dataset.loaded!=="true"){if(!we()){En(u,"Enter registry details first.");return}En(u,"Loading versions…");try{const E=te(P.baseUrl),h=pe.get(l),M=P.groupId.trim(),H=(h==null?void 0:h._groupId)||M,B=await hn(E,H,l);fe.set(l,B),u.dataset.loaded="true",yt(l,B)}catch(E){console.error("[Blockscape] failed to load versions",E),En(u,`Unable to fetch versions: ${E.message}`)}}}function wt(l,u){var E;const _=o.findIndex(h=>h.apicurioArtifactId===l);if(_!==-1){const h=o[_].id;o[_]={...u,id:h||u.id},((E=o[_].apicurioVersions)==null?void 0:E.length)>1&&(o[_].isSeries=!0),f(_)}else o.push(u),f(o.length-1)}async function at(l,u,_,E){const h=encodeURIComponent(u),M=encodeURIComponent(_),H=`${l}/groups/${h}/artifacts/${M}`;try{const B=await fetch(H,{method:"GET",headers:E});if(B.status===404)return!1;if(B.ok)return!0;throw B.status===401||B.status===403?new Error("Authentication failed while checking the registry."):new Error(`Registry responded with status ${B.status} while checking the artifact.`)}catch(B){throw B instanceof TypeError?new Error("Network error while contacting Apicurio registry."):B}}async function st(){var H;if(!re||re.dataset.loading==="true")return;if(!ge()){R("Apicurio integration is off. Enable it first.","error");return}if(!we()){R("Enter the registry base URL and group ID before pushing.","error");return}const l=c();if(l<0||!o[l]){R("No active model to push.","error");return}const u=Ke(o[l],{fallbackTitle:m(o[l])});if(!u){R("Active model needs an id before pushing.","error");return}const _=te(P.baseUrl),E=P.groupId.trim(),h=JSON.stringify(o[l].data,null,2),M=We();re.dataset.loading="true",re.textContent="Pushing…",re.disabled=!0,R("Pushing to Apicurio…","muted");try{const B=await at(_,E,u,M),ae=G(o[l].data);if(B)try{const Te=await On(_,E,u),{data:tn,fingerprint:an}=await De(_,E,u,Te);if(console.group("[Blockscape] Apicurio push compare"),console.log("compare version",Te),console.log("local fingerprint",ae),console.log("registry fingerprint",an),console.log("local payload",o[l].data),console.log("registry payload",tn),console.groupEnd(),ae&&an&&ae===an){if(!window.confirm("The current registry version is identical to this model. Push anyway?")){R("Push cancelled (content matches the latest registry version).","muted");return}R("Pushing identical content by user choice.","muted")}else an?console.log("[Blockscape] Apicurio compare mismatch (proceeding with push)"):R("Unable to compare with registry content (skipping confirmation).","muted")}catch(Te){console.warn("[Blockscape] unable to compare registry content before push",Te),R("Skipped comparison with registry (content fetch failed). Proceeding with push.","muted")}const Y=P.useSemver?await Ye(_,E,u,B):null;if(P.useSemver&&!Y)throw new Error("Semantic versioning is enabled but no version could be computed.");const ee=encodeURIComponent(E),ke=encodeURIComponent(u),He=B?`${_}/groups/${ee}/artifacts/${ke}/versions`:`${_}/groups/${ee}/artifacts`,se={...M,"Content-Type":"application/json"};Y&&(se["X-Registry-Version"]=Y,R(`Pushing to Apicurio as version ${Y}…`,"muted"));const mn=B?w(h,{version:Y}):S(u,h,{title:m(o[l]),description:(H=o[l].data)==null?void 0:H.abstract,version:Y}),fn=await fetch(He,{method:"POST",headers:se,body:JSON.stringify(mn)});if(!fn.ok){let Te=fn.statusText||"Unknown error";try{const tn=await fn.text();tn&&(Te=tn.slice(0,400))}catch{}throw new Error(`Registry rejected the push (${fn.status}): ${Te}`)}let nn=null;try{nn=await fn.json()}catch{nn=null}const ue=(nn==null?void 0:nn.version)||(nn==null?void 0:nn.globalId)||"",Fe=B?"Updated":"Created",wn=ue?` (version ${ue})`:"";R(`${Fe} ${u}${wn}`,"success")}catch(B){console.error("[Blockscape] Apicurio push failed",B),R(`Apicurio push failed: ${B.message}`,"error")}finally{re.dataset.loading="false",Be()}}async function Dt(){var Y,ee;if(!F||F.dataset.loading==="true")return;if(!ge()){R("Apicurio integration is off. Enable it first.","error");return}if(!we()){R("Enter the registry base URL and group ID before pushing.","error");return}const l=c(),u=l>=0?o[l]:null;if(!u||!u.apicurioVersions||u.apicurioVersions.length<2){R("Series push requires a model with multiple versions.","error");return}const _=Ke(u,{seriesName:u.title||u.apicurioArtifactName||m(u)});if(!_){R("Active series needs an id before pushing.","error");return}typeof k=="function"&&k(u,{seriesName:u.title||u.apicurioArtifactName||m(u)});const E=te(P.baseUrl),h=P.groupId.trim(),M=u.apicurioVersions.map(ke=>ke.data),H=JSON.stringify(M,null,2),B=We(),ae=le(h);F.dataset.loading="true",F.textContent="Pushing…",F.disabled=!0,R("Pushing series to Apicurio…","muted");try{const ke=await at(E,ae,_,B),He=G(M);if(ke)try{const ln=await On(E,ae,_),{data:qn,fingerprint:Vn}=await De(E,ae,_,ln);if(console.group("[Blockscape] Apicurio series push compare"),console.log("compare version",ln),console.log("local fingerprint",He),console.log("registry fingerprint",Vn),console.log("local payload (series)",M),console.log("registry payload",qn),console.groupEnd(),He&&Vn&&He===Vn){if(!window.confirm("The current registry version matches this series. Push anyway?")){R("Series push cancelled (content matches latest).","muted");return}R("Pushing identical series by user choice.","muted")}else Vn?console.log("[Blockscape] Apicurio compare mismatch (proceeding with series push)"):R("Unable to compare with registry content (skipping confirmation).","muted")}catch(ln){console.warn("[Blockscape] unable to compare registry content before series push",ln),R("Skipped comparison with registry (content fetch failed). Proceeding with series push.","muted")}const se=P.useSemver?await Ye(E,ae,_,ke):null;if(P.useSemver&&!se)throw new Error("Semantic versioning is enabled but no version could be computed.");const mn=encodeURIComponent(ae),fn=encodeURIComponent(_),nn=ke?`${E}/groups/${mn}/artifacts/${fn}/versions`:`${E}/groups/${mn}/artifacts`,ue={...B,"Content-Type":"application/json"};se&&(ue["X-Registry-Version"]=se,R(`Pushing series to Apicurio as version ${se}…`,"muted"));const Fe=ke?w(H,{version:se}):S(_,H,{title:u.apicurioArtifactName||((Y=u.data)==null?void 0:Y.title)||_,description:(ee=u.data)==null?void 0:ee.abstract,version:se}),wn=await fetch(nn,{method:"POST",headers:ue,body:JSON.stringify(Fe)});if(!wn.ok){let ln=wn.statusText||"Unknown error";try{const qn=await wn.text();qn&&(ln=qn.slice(0,400))}catch{}throw new Error(`Registry rejected the series push (${wn.status}): ${ln}`)}let Te=null;try{Te=await wn.json()}catch{Te=null}const tn=(Te==null?void 0:Te.version)||(Te==null?void 0:Te.globalId)||"",an=ke?"Updated":"Created",_n=tn?` (version ${tn})`:"";R(`${an} ${_} series${_n}`,"success")}catch(ke){console.error("[Blockscape] Apicurio series push failed",ke),R(`Apicurio series push failed: ${ke.message}`,"error")}finally{F.dataset.loading="false",Be()}}async function ot(){if(!J||J.dataset.loading==="true")return;if(!ge()){R("Enable Apicurio integration to list artifacts.","error");return}if(!we()){R("Enter registry base URL and group ID before listing.","error");return}const l=te(P.baseUrl),u=P.groupId.trim(),_=le(u),E=[{groupId:u,label:"base"},{groupId:_,label:"series"}];J.dataset.loading="true",J.textContent="Listing…",J.disabled=!0,R("Listing artifacts…","muted"),Q("Contacting registry…");try{const h=We();h.Accept="application/json";const M=[];for(const B of E){const ae=encodeURIComponent(B.groupId),Y=`${l}/groups/${ae}/artifacts?limit=50&offset=0`,ee=await fetch(Y,{method:"GET",headers:h});if(!ee.ok){let se=ee.statusText||"Unknown error";try{const mn=await ee.text();mn&&(se=mn.slice(0,400))}catch{}console.warn(`[Blockscape] failed to list artifacts for group ${B.groupId} (${ee.status}): ${se}`);continue}const ke=await ee.json(),He=L(ke).filter(se=>se&&se.artifactId);He.forEach(se=>{se&&(se._groupId=B.groupId)}),M.push(...He)}pe.clear(),fe.clear(),M.forEach(B=>{B!=null&&B.artifactId&&pe.set(B.artifactId,B)}),Cn(M);const H=M.length;R(H?`Found ${H} artifact${H===1?"":"s"} across base and series groups.`:"No artifacts found in base/series groups.",H?"success":"muted")}catch(h){console.error("[Blockscape] failed to list artifacts",h),Ve("Unable to list artifacts."),R(`Listing failed: ${h.message}`,"error")}finally{J.dataset.loading="false",Be()}}async function zn(l,u=null){var ke,He,se,mn,fn,nn;if(!l)return;if(!ge()){R("Enable Apicurio integration to load artifacts.","error");return}if(!we()){R("Enter registry connection details before loading artifacts.","error");return}const _=te(P.baseUrl),E=P.groupId.trim(),h=l&&((ke=pe.get(l))==null?void 0:ke._groupId)||E;let M=pe.get(l);const H=async()=>{try{const ue=await pn(_,h,l);return ue!=null&&ue.artifactId&&pe.set(l,ue),ue}catch(ue){throw console.error("[Blockscape] failed to fetch artifact metadata before loading",ue),ue}};if(!M)try{M=await H()}catch(ue){R(`Failed to fetch artifact metadata: ${ue.message}`,"error");return}const B=fe.get(l)||[];let ae="latest",Y="latest";if(u)ae=u,Y=u;else{if(!M||M.version==null)try{M=await H()}catch(ue){R(`Failed to fetch artifact metadata: ${ue.message}`,"error");return}ae=(M==null?void 0:M.version)||"latest",Y=(M==null?void 0:M.version)||"latest"}const ee=B.find(ue=>String(ue.version)===String(ae));(ee==null?void 0:ee.version)!=null&&(Y=ee.version),R(`Loading artifact ${l}…`,"muted");try{const ue=await un(_,h,l,ae),Fe=pe.get(l)||M||{},wn=Array.isArray(ue);let Te=null;if(wn){const tn=ue.map((_n,ln)=>(C(_n,{titleHint:Fe.name||l,idHint:l}),{version:String(ln+1),data:_n,createdOn:(ee==null?void 0:ee.createdOn)||Fe.createdOn}));Te={id:q(),title:((se=(He=tn[0])==null?void 0:He.data)==null?void 0:se.title)||Fe.name||l,data:(mn=tn[0])==null?void 0:mn.data,apicurioArtifactId:l,apicurioArtifactName:Fe.name||"",apicurioVersions:tn,apicurioActiveVersionIndex:0,isSeries:!0};const an=((fn=Fe==null?void 0:Fe.properties)==null?void 0:fn.seriesId)||l;typeof k=="function"&&k(Te,{seriesName:an,fallbackTitle:an}),R(`Loaded series artifact ${l}.`,"success")}else{C(ue,{titleHint:Fe.name||l,idHint:l});const tn={version:Y,data:ue,createdOn:(ee==null?void 0:ee.createdOn)||Fe.createdOn};Te={id:q(),title:ue.title||Fe.name||l,data:ue,apicurioArtifactId:l,apicurioArtifactName:Fe.name||"",apicurioVersions:[tn],apicurioActiveVersionIndex:0};const an=(nn=Fe==null?void 0:Fe.properties)==null?void 0:nn.seriesId;an&&typeof k=="function"&&k(Te,{seriesName:an,fallbackTitle:an});const _n=Y?` (version ${Y})`:"";R(`Loaded artifact ${l}${_n}.`,"success")}wt(l,Te)}catch(ue){console.error("[Blockscape] failed to load artifact",ue),R(`Failed to load artifact: ${ue.message}`,"error")}}async function Ot(l){}return{hydrateConfig:Ae,mount:vn,updateAvailability:Be,isEnabled:ge,setEnabled:Bt,onEnabledChange:en}}function Lt(o,c){if(typeof o!="function")throw new Error(`[itemEditor] expected ${c} to be a function`)}function ql(o,{excludeId:c}={}){if(!o)return[];const f=o.split(/[\s,]+/).map(k=>k.trim()).filter(Boolean),C=[];return f.forEach(k=>{c&&k===c||C.includes(k)||C.push(k)}),C}function Wl(o,c,f){if(!c||!f||c===f)return;((o==null?void 0:o.categories)||[]).forEach(k=>{(k.items||[]).forEach(N=>{Array.isArray(N.deps)&&(N.deps=N.deps.map(j=>j===c?f:j))})}),Array.isArray(o==null?void 0:o.links)&&o.links.forEach(k=>{k.from===c&&(k.from=f),k.to===c&&(k.to=f)})}function Gl({findItemAndCategoryById:o,collectAllItemIds:c,updateItemReferences:f,loadActiveIntoEditor:C,rebuildFromActive:k,select:N,onSelectionRenamed:j}={}){Lt(o,"findItemAndCategoryById"),Lt(c,"collectAllItemIds"),Lt(f,"updateItemReferences"),Lt(C,"loadActiveIntoEditor"),Lt(k,"rebuildFromActive"),Lt(N,"select");const m={wrapper:null,fields:{},categoryId:null,itemId:null,modelData:null};function G($){if(m.fields.errorEl){if(!$){m.fields.errorEl.hidden=!0,m.fields.errorEl.textContent="";return}m.fields.errorEl.hidden=!1,m.fields.errorEl.textContent=$}}function q(){m.wrapper&&(m.wrapper.hidden=!0,m.wrapper.setAttribute("aria-hidden","true"),G(""),m.categoryId=null,m.itemId=null,m.modelData=null,document.body.classList.remove("item-editor-open"))}function re(){m.wrapper&&(m.wrapper.hidden=!1,m.wrapper.setAttribute("aria-hidden","false"),document.body.classList.add("item-editor-open"),requestAnimationFrame(()=>{var $,W;($=m.fields.nameInput)==null||$.focus(),(W=m.fields.nameInput)==null||W.select()}))}function J($){var te;if(!m.modelData||!m.categoryId||!m.itemId)throw new Error("No item loaded.");const Z=(((te=m.modelData)==null?void 0:te.categories)||[]).find(le=>le.id===m.categoryId);if(!Z)throw new Error("Category not found.");Z.items=Z.items||[];const F=Z.items.find(le=>le.id===m.itemId);if(!F)throw new Error("Item not found.");const X=($.id||"").trim();if(!X)throw new Error("ID is required.");const Se=c(m.modelData);if(X!==F.id&&Se.has(X))throw new Error("Another item already uses that ID.");F.id=X;const P=($.name||"").trim();F.name=P||F.id;const pe=($.logo||"").trim();if(pe?F.logo=pe:delete F.logo,$.externalFlag&&!$.external)F.external=!0;else{const le=($.external??"").toString().trim();le?F.external=le:delete F.external}const fe=($.color||"").trim();return fe?F.color=fe:delete F.color,F.deps=Array.isArray($.deps)?$.deps:[],F.id!==$.originalId&&typeof j=="function"&&j($.originalId,F.id),f(m.modelData,$.originalId,F.id),C(),k(),N(F.id),F.id}function de(){if(!m.fields||!m.fields.idInput)return!1;const $=(m.fields.idInput.value||"").trim(),W={originalId:m.itemId,id:$,name:m.fields.nameInput.value||"",logo:m.fields.logoInput.value||"",external:m.fields.externalInput.value||"",externalFlag:m.fields.externalFlagInput.checked,color:m.fields.colorInput.value||"",deps:ql(m.fields.depsInput.value,{excludeId:$})};try{return J(W),q(),!0}catch(Z){return console.warn("[itemEditor] item edit failed",Z),G((Z==null?void 0:Z.message)||"Unable to save item."),!1}}function me(){if(m.wrapper)return m.wrapper;const $=document.createElement("div");$.className="item-editor-modal",$.hidden=!0,$.setAttribute("role","dialog"),$.setAttribute("aria-modal","true");const W=document.createElement("div");W.className="item-editor-modal__backdrop",$.appendChild(W);const Z=document.createElement("div");Z.className="item-editor",$.appendChild(Z);const F=document.createElement("div");F.className="item-editor__header";const X=document.createElement("h2");X.className="item-editor__title",X.textContent="Edit item";const Se=document.createElement("button");Se.type="button",Se.className="item-editor__close",Se.setAttribute("aria-label","Close item editor"),Se.textContent="×",F.appendChild(X),F.appendChild(Se),Z.appendChild(F);const P=document.createElement("form");P.className="item-editor__form",Z.appendChild(P);const pe=document.createElement("div");pe.className="item-editor__meta",pe.innerHTML='<div class="item-editor__meta-label">Category</div><div class="item-editor__meta-value"></div>',P.appendChild(pe);const fe=document.createElement("div");fe.className="item-editor__error",fe.hidden=!0,P.appendChild(fe);const te=(S,w,Ge)=>{const _e=document.createElement("label");_e.className="item-editor__field";const V=document.createElement("span");if(V.className="item-editor__label",V.textContent=S,_e.appendChild(V),w.classList.add("item-editor__control"),_e.appendChild(w),Ge){const be=document.createElement("div");be.className="item-editor__hint",be.textContent=Ge,_e.appendChild(be)}return _e},le=document.createElement("input");le.type="text",le.required=!0,P.appendChild(te("ID",le,"Unique identifier used for links and dependencies."));const we=document.createElement("input");we.type="text",P.appendChild(te("Name",we,"Visible label shown on the tile."));const ge=document.createElement("input");ge.type="url",ge.inputMode="url",ge.placeholder="https://…",P.appendChild(te("Logo URL",ge,"Optional image URL."));const ve=document.createElement("input");ve.type="url",ve.inputMode="url",ve.placeholder="https://…",P.appendChild(te("External link",ve,"Shown with ↗ icon and in preview."));const en=document.createElement("div");en.className="item-editor__checkbox";const je=document.createElement("label");je.className="item-editor__checkbox-row";const R=document.createElement("input");R.type="checkbox";const Q=document.createElement("span");Q.textContent="Mark as external without link";const Ve=document.createElement("div");Ve.className="item-editor__hint",Ve.textContent="Keeps dashed border even without a URL.",je.appendChild(R),je.appendChild(Q),en.appendChild(je),en.appendChild(Ve),P.appendChild(en);const Be=document.createElement("input");Be.type="text",Be.placeholder="#2563eb",P.appendChild(te("Color",Be,"Optional badge color (hex or CSS color)."));const $e=document.createElement("textarea");$e.rows=2,$e.placeholder="Comma or space separated ids",P.appendChild(te("Dependencies",$e,"Use item IDs, separated by commas or spaces."));const qe=document.createElement("div");qe.className="item-editor__actions";const Ae=document.createElement("button");Ae.type="button",Ae.className="pf-v5-c-button pf-m-tertiary",Ae.textContent="Cancel";const We=document.createElement("button");return We.type="submit",We.className="pf-v5-c-button pf-m-primary",We.textContent="Save",qe.appendChild(Ae),qe.appendChild(We),P.appendChild(qe),m.wrapper=$,m.fields={idInput:le,nameInput:we,logoInput:ge,externalInput:ve,externalFlagInput:R,colorInput:Be,depsInput:$e,categoryValue:pe.querySelector(".item-editor__meta-value"),errorEl:fe},Ae.addEventListener("click",q),Se.addEventListener("click",q),W.addEventListener("click",q),P.addEventListener("submit",S=>{S.preventDefault(),de()}),document.addEventListener("keydown",S=>{S.key==="Escape"&&!$.hidden&&(S.preventDefault(),S.stopPropagation(),q())}),document.body.appendChild($),$}function Re($){const W=o($);return W?(me(),m.categoryId=W.category.id,m.itemId=W.item.id,m.modelData=W.modelData,m.fields.categoryValue.textContent=W.category.title||W.category.id,m.fields.idInput.value=W.item.id||"",m.fields.nameInput.value=W.item.name||"",m.fields.logoInput.value=W.item.logo||"",m.fields.externalInput.value=typeof W.item.external=="string"?W.item.external:"",m.fields.externalFlagInput.checked=W.item.external===!0,m.fields.colorInput.value=W.item.color||"",m.fields.depsInput.value=Array.isArray(W.item.deps)?W.item.deps.join(", "):"",G(""),N(W.item.id),re(),!0):!1}return{open:Re,hide:q,isOpen:()=>!!m.wrapper&&!m.wrapper.hidden}}function Bs(o,c="series"){return(o||c).trim().toLowerCase().replace(/[^a-z0-9._-]+/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"")||c}function vt(o,c="series"){const f=Bs(o,c).replace(/\./g,"-");return f.replace(/-series$/i,"").replace(/-+$/,"")||f||Bs(c,"series")}function js(o,{seriesName:c,fallbackTitle:f="unknown"}={}){var m,G;const k=[o==null?void 0:o.seriesId,(m=o==null?void 0:o.data)==null?void 0:m.seriesId,o==null?void 0:o.apicurioArtifactId,c,o==null?void 0:o.title,o==null?void 0:o.apicurioArtifactName,(G=o==null?void 0:o.data)==null?void 0:G.title,f].map(q=>(q??"").toString().trim()),N=k.findIndex(Boolean),j=N!==-1?k[N]:"";return j?(console.log("[Series] deriveSeriesId: picked base",{base:j,sourceIndex:N,candidates:k}),vt(j,f)):(console.log("[Series] deriveSeriesId: no base found; fallback",{fallbackTitle:f}),null)}function gn(o,{seriesName:c,fallbackTitle:f="unknown"}={}){if(!o||typeof o!="object")return null;const C=js(o,{seriesName:c,fallbackTitle:f});return C?(o.seriesId=C,o.apicurioArtifactId||(o.apicurioArtifactId=C),C):null}function Nt(o,c={}){var k,N;if(!o)return null;const f=o.isSeries||((k=o.apicurioVersions)==null?void 0:k.length)>1||o.seriesId||((N=o.data)==null?void 0:N.seriesId)||o.apicurioArtifactId;if(!f&&!c.force)return null;const C=js(o,c);return C||(f?vt(c.fallbackTitle||"unknown"):null)}const Pi=typeof import.meta<"u"&&"./"||"",Ri=["comms.bs","planets.bs","styleguide.bs","blockscape-features.bs"],qs=Object.assign({"../public/APIs.bs":bl,"../public/NFR.bs":vl,"../public/blockscape-features.bs":yl,"../public/comms.bs":wl,"../public/deploy.bs":kl,"../public/network/a-network.bs":Sl,"../public/network/anycast-delivery.bs":Cl,"../public/network/caching-series.bs":El,"../public/network/congestion-control-algorithms-series.bs":_l,"../public/network/core-transport-protocols-series.bs":Il,"../public/network/geodns-edns-client-subnet.bs":xl,"../public/network/health-checks.bs":Al,"../public/network/ip-fragmentation-path-mtu-discovery.bs":Tl,"../public/network/l4-load-balancing.bs":Ll,"../public/network/l7-load-balancing.bs":Nl,"../public/network/observability-troubleshooting-concepts.bs":Ml,"../public/network/recursive-vs-authoritative-dns.bs":Pl,"../public/network/reverse-proxying.bs":Rl,"../public/network/tcp-data-delivery.bs":Bl,"../public/network/throughput-latency-congestion-series.bs":Dl,"../public/network/tls-handshake-secure-delivery.bs":Ol,"../public/network/udp-data-delivery.bs":Ul,"../public/planets.bs":Vl,"../public/styleguide.bs":$l,"../public/user-capabilities-models.bs":Hl,"../public/wardley.bs":Fl}),ht="__default__";function Di(o){return(o||"").replace(/^\.?\/+/,"").replace(/^public\//,"").replace(/^\.\.\/public\//,"")}function Jl(o){if(!o)return"";const c=Di(o);return Pi?Pi.endsWith("/")?`${Pi}${c}`:`${Pi}/${c}`:c}function zl(o){const c=Di(o);return qs[`../public/${c}`]??null}function Kl(){const o=new Map;return Object.keys(qs).forEach(c=>{const C=Di(c.replace(/^\.\.\//,"")).split("/");if(C.length<=1)return;const k=C.pop(),N=C.join("/");o.has(N)||o.set(N,[]),o.get(N).push({filename:k,relativePath:`${N}/${k}`})}),o.forEach(c=>c.sort((f,C)=>f.filename.localeCompare(C.filename))),o}function Ql(){console.log("[Blockscape] init");let o="";const c=document.getElementById("jsonBox"),f=document.querySelector(".blockscape-json-panel"),C=document.getElementById("app"),k=document.getElementById("overlay"),N=document.getElementById("tabTooltip"),j=document.getElementById("modelList"),m=document.getElementById("itemPreview"),G=document.getElementById("urlForm"),q=document.getElementById("urlInput"),re=document.getElementById("loadUrl"),J=m.querySelector(".item-preview__title"),de=m.querySelector(".item-preview__body"),me=m.querySelector(".item-preview__actions"),Re=m.querySelector(".item-preview__close"),$=document.getElementById("downloadJson"),W=document.getElementById("shareModel"),Z=document.getElementById("createVersion"),F=document.getElementById("openInEditor"),X=document.getElementById("copyJson"),Se=document.getElementById("copySeries"),P=document.getElementById("pasteJson"),pe=document.getElementById("helpButton"),fe=document.getElementById("newPanelButton"),te=document.getElementById("shortcutHelp"),le=document.getElementById("shortcutHelpList"),we=document.getElementById("shortcutHelpClose"),ge=document.getElementById("shortcutHelpBackdrop"),ve=document.getElementById("newPanel"),en=document.getElementById("newPanelClose"),je=document.getElementById("newPanelBackdrop"),R=document.getElementById("search"),Q=document.getElementById("searchResults"),Ve=document.getElementById("modelSets"),Be="blockscape:editorPayload",$e="blockscape:editorTransfer",qe=document.title,Ae=document.getElementById("seed"),We=Kl();o=((Ae==null?void 0:Ae.textContent)||(Ae==null?void 0:Ae.innerHTML)||"").trim(),o&&c&&(c.value=o);let S=[],w=-1,Ge=ht;const _e=jl({models:S,getActiveIndex:()=>w,setActive:Ze,ensureModelMetadata:lt,getModelId:Je,getSeriesId:Nt,ensureSeriesId:gn,getModelTitle:Oe,computeJsonFingerprint:fi,uid:rt});let V=null,be=new Map,Ke=new Map,L=null,z=null,ne=null,he=null,pn=!0,hn=!1,un=0,De={x:0,y:0},On="map",Ye=null,ie=null,Ne=!1,Bt=null;const pi=2e3;let Fn=null,bn=null,Un=null,vn=null,Cn=null,yn=null,En=null,yt=null,jn=null,wt="",at=!1,st=null,Dt=null,ot=null,zn=[],Ot=null;const l=30,u=1e3,_="blockscape:hoverScale",E=1.5,h=1,M=2.5,H="blockscape:titleWrap",B="blockscape:titleHoverWidth",ae="blockscape:titleHoverTextPortion",Y="wrap",ee=1.3,ke=1,He=1.6,se=.25,mn=0,fn=.6,nn="blockscape:tileCompactness",ue=1,Fe=.75,wn=1.25,Te="blockscape:obsidianLinksEnabled",tn="blockscape:obsidianLinkMode",an="blockscape:obsidianVault",_n="title",ln="id",qn=_n;let Vn=E,kt=ue,Oa=Y,Ut=ee,Vt=se,$t=!1,ui=qn,Ht="";const Ua="blockscape:seriesNavDoubleClickMs",Ft=900,Va=300,$a=4e3;let Kn=Ft;_e.hydrateConfig(),to(),ao(),po(),oo(),lo(),fo(),yo(),bo(),ko(),sn();function rt(){return Math.random().toString(36).slice(2,10)}function Ws(e){const n=new TextEncoder().encode(e);let t="";return n.forEach(i=>{t+=String.fromCharCode(i)}),btoa(t)}function Gs(e){const n=atob(e),t=new Uint8Array(n.length);for(let i=0;i<n.length;i++)t[i]=n.charCodeAt(i);return new TextDecoder().decode(t)}function Js(e){return Ws(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}function zs(e){let n=e.replace(/-/g,"+").replace(/_/g,"/");const t=n.length%4;return t&&(n+="=".repeat(4-t)),Gs(n)}function Ks(e,n){const t=new Blob([n],{type:"application/json"}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=e,a.click(),URL.revokeObjectURL(i)}async function Ha(e){var n;if(!((n=navigator.clipboard)!=null&&n.writeText))return!1;try{return await navigator.clipboard.writeText(e),!0}catch(t){return console.warn("[Blockscape] clipboard write failed",t),!1}}async function Qs(){var e;if(!((e=navigator.clipboard)!=null&&e.readText))throw new Error("Clipboard read not supported");return navigator.clipboard.readText()}function jt(e){return(e||"blockscape").trim().toLowerCase().replace(/[^a-z0-9._-]+/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"")||"blockscape"}function Xs(e){return Number.isFinite(e)?Math.min(M,Math.max(h,e)):E}function sn(){if(!C)return;const e=!!L||!!z;C.classList.toggle("blockscape-has-selection",e)}function qt(e){return Vn=Xs(e),document.documentElement.style.setProperty("--blockscape-tile-hover-scale",Vn),Vn}function Ys(e){return Number.isFinite(e)?Math.min(wn,Math.max(Fe,e)):ue}function Wt(e){return kt=Ys(e),document.documentElement.style.setProperty("--blockscape-tile-compactness",kt),kt}function Zs(e){return Number.isFinite(e)?Math.min(He,Math.max(ke,e)):ee}function Gt(e){return Ut=Zs(e),document.documentElement.style.setProperty("--blockscape-title-hover-width-multiplier",Ut),Ut}function eo(e){return Number.isFinite(e)?Math.min(fn,Math.max(mn,e)):se}function Jt(e){return Vt=eo(e),document.documentElement.style.setProperty("--blockscape-tile-hover-text-portion",Vt),Vt}function zt(e){const n=e==="nowrap"?"nowrap":"wrap";Oa=n;const t=n==="nowrap"?"nowrap":"normal",i=n==="nowrap"?"nowrap":"normal";return document.documentElement.style.setProperty("--blockscape-title-white-space",t),document.documentElement.style.setProperty("--blockscape-title-text-wrap",i),n}function no(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(_,String(e))}catch(n){console.warn("[Blockscape] failed to persist hover scale",n)}}function to(){if(typeof window>"u"||!window.localStorage)return qt(E);try{const e=window.localStorage.getItem(_);if(!e)return qt(E);const n=parseFloat(e);return qt(n)}catch(e){return console.warn("[Blockscape] failed to read hover scale",e),qt(E)}}function io(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(nn,String(e))}catch(n){console.warn("[Blockscape] failed to persist tile compactness",n)}}function ao(){if(typeof window>"u"||!window.localStorage)return Wt(ue);try{const e=window.localStorage.getItem(nn);if(!e)return Wt(ue);const n=parseFloat(e);return Wt(n)}catch(e){return console.warn("[Blockscape] failed to read tile compactness",e),Wt(ue)}}function so(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(B,String(e))}catch(n){console.warn("[Blockscape] failed to persist title hover width",n)}}function oo(){if(typeof window>"u"||!window.localStorage)return Gt(ee);try{const e=window.localStorage.getItem(B);if(!e)return Gt(ee);const n=parseFloat(e);return Gt(n)}catch(e){return console.warn("[Blockscape] failed to read title hover width",e),Gt(ee)}}function ro(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(ae,String(e))}catch(n){console.warn("[Blockscape] failed to persist title text zoom",n)}}function lo(){if(typeof window>"u"||!window.localStorage)return Jt(se);try{const e=window.localStorage.getItem(ae);if(!e)return Jt(se);const n=parseFloat(e);return Jt(n)}catch(e){return console.warn("[Blockscape] failed to read title text zoom",e),Jt(se)}}function co(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(H,e)}catch(n){console.warn("[Blockscape] failed to persist title wrap mode",n)}}function po(){if(typeof window>"u"||!window.localStorage)return zt(Y);try{const e=window.localStorage.getItem(H);return zt(e||Y)}catch(e){return console.warn("[Blockscape] failed to read title wrap mode",e),zt(Y)}}function uo(e){return Number.isFinite(e)?Math.min($a,Math.max(Va,e)):Ft}function Kt(e){return Kn=uo(e),Kn}function mo(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(Ua,String(e))}catch(n){console.warn("[Blockscape] failed to persist series double-click wait",n)}}function fo(){if(typeof window>"u"||!window.localStorage)return Kt(Ft);try{const e=window.localStorage.getItem(Ua);if(!e)return Kt(Ft);const n=parseInt(e,10);return Kt(n)}catch(e){return console.warn("[Blockscape] failed to read series double-click wait",e),Kt(Ft)}}function go(e){return e===ln?ln:_n}function Qt(e){return ui=go(e),ui}function ho(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(tn,e)}catch(n){console.warn("[Blockscape] failed to persist Obsidian link mode",n)}}function bo(){if(typeof window>"u"||!window.localStorage)return Qt(qn);try{const e=window.localStorage.getItem(tn);return Qt(e||qn)}catch(e){return console.warn("[Blockscape] failed to read Obsidian link mode",e),Qt(qn)}}function Xt(e){return $t=!!e,$t}function vo(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(Te,e?"1":"0")}catch(n){console.warn("[Blockscape] failed to persist Obsidian toggle",n)}}function yo(){if(typeof window>"u"||!window.localStorage)return Xt(!1);try{const e=window.localStorage.getItem(Te);return e==null?Xt(!1):Xt(e==="1")}catch(e){return console.warn("[Blockscape] failed to read Obsidian toggle",e),Xt(!1)}}function Yt(e){return Ht=(e??"").toString().trim(),Ht}function wo(e){if(!(typeof window>"u"||!window.localStorage))try{window.localStorage.setItem(an,e)}catch(n){console.warn("[Blockscape] failed to persist Obsidian vault",n)}}function ko(){if(typeof window>"u"||!window.localStorage)return Yt("");try{const e=window.localStorage.getItem(an);return Yt(e||"")}catch(e){return console.warn("[Blockscape] failed to read Obsidian vault",e),Yt("")}}function So(e){return typeof window>"u"||typeof window.prompt!="function"?null:(window.prompt("Name this series",e)||"").trim()||null}function Co(e,n="Pasted"){const t=Array.isArray(e)?e:[];if(!t.length)return`${n} series`;const i=t.find(s=>s&&typeof s=="object")||t[0];return((i==null?void 0:i.title)??"").toString().trim()||`${n} series`}function mi(e,n){!n||!e||typeof e!="object"||(e.seriesId=n,e.apicurioArtifactId=n,e.id=n,e.data&&typeof e.data=="object"&&(e.data.seriesId=n),Array.isArray(e.apicurioVersions)&&e.apicurioVersions.forEach(t=>{t!=null&&t.data&&typeof t.data=="object"&&(t.data.seriesId=n)}))}function Eo(e){if(!e||typeof window>"u"||typeof window.prompt!="function")return!1;const n=(e.title??e.apicurioArtifactName??"").toString().trim()||gi(e,"Series"),t=window.prompt("Series name",n);if(t==null)return!1;const i=t.trim();if(!i)return!1;const a=Nt(e,{seriesName:i,fallbackTitle:i})||vt(i,i),s=window.prompt("Series ID (used for linking and downloads)",a);if(s==null)return!1;const r=vt(s.trim()||i,i||"series");return e.title=i,e.apicurioArtifactName=i,mi(e,r),!0}function Oi(e){return e===null||typeof e!="object"?JSON.stringify(e):Array.isArray(e)?`[${e.map(i=>Oi(i)).join(",")}]`:`{${Object.keys(e).sort().map(i=>`${JSON.stringify(i)}:${Oi(e[i])}`).join(",")}}`}function Fa(e){try{return Oi(e)}catch{return""}}function fi(e){try{const n=typeof e=="string"?JSON.parse(e):e,t=Fa(n);if(t)return t}catch(n){console.warn("[Blockscape] fingerprint parse failed (first pass)",n)}try{const n=JSON.parse(JSON.stringify(e)),t=Fa(n);if(t)return t}catch(n){console.warn("[Blockscape] fingerprint failed for value",n)}try{return JSON.stringify(e)||""}catch{return""}}const _o=[{keys:[["Arrow Left"],["Arrow Right"]],description:"Move selection to the previous or next item in the current category."},{keys:[["Arrow Up"],["Arrow Down"]],description:"Move up/down through items, pausing on category headers before entering the next category at the same relative position."},{keys:[["Cmd/Ctrl","Arrow Up"],["Cmd/Ctrl","Arrow Down"]],description:"Reorder the selected category (or the category that holds the selected item)."},{keys:[["Shift","Arrow Left"],["Shift","Arrow Right"]],description:"Reorder the selected item inside its category."},{keys:[["Shift","Arrow Up"],["Shift","Arrow Down"]],description:"Move the selected item to the previous or next category."},{keys:[["Cmd/Ctrl","Arrow Left"],["Cmd/Ctrl","Arrow Right"]],description:"Switch to the previous or next map when viewing a series."},{keys:[["Cmd/Ctrl","Z"]],description:"Undo the last deleted tile or category."},{keys:[["Cmd/Ctrl","S"]],description:"Download the active model JSON (series if multiple versions are open)."},{keys:[["Cmd/Ctrl","V"]],description:"Append JSON models from the clipboard when focus is outside inputs."},{keys:[["Enter"],["Space"]],description:"Activate a focused tile, same as clicking it."},{keys:[["F2"]],description:"Edit the selected item; when a category (not an item) is selected, open the category editor."},{keys:[["Delete"]],description:"Delete the selected item or category (use Cmd/Ctrl+Z to undo)."},{keys:[["Insert"]],description:"Add a new category at the bottom of the map."},{keys:[["Escape"]],description:"Unselect item or close the open preview popover."}];function lt(e,{titleHint:n="Untitled Model",idHint:t}={}){if(!e||typeof e!="object")return e;const i=(e.title??"").toString().trim();e.title=i||n||"Untitled Model";const a=(e.id??"").toString().trim();if(a)e.id=a;else{const s=t||e.title||n||"model",r=jt(s).replace(/\./g,"-");e.id=r||`model-${rt()}`}return typeof e.abstract!="string"&&(e.abstract=e.abstract==null?"":String(e.abstract)),e}function Io(e){return JSON.parse(JSON.stringify(e))}function Oe(e,n="Untitled Model"){var i;return e&&(((i=e.data)==null?void 0:i.title)??e.title??"").toString().trim()||n}function gi(e,n="Untitled Model"){var i;if(((i=e==null?void 0:e.apicurioVersions)==null?void 0:i.length)>1||(e==null?void 0:e.isSeries)){const a=((e==null?void 0:e.title)??"").toString().trim()||((e==null?void 0:e.apicurioArtifactName)??"").toString().trim();if(a)return a;const s=Je(e);return s?`${s} series`:n}return Oe(e,n)}function Je(e){var a;const n=Nt(e);if(n)return n;const t=(a=e==null?void 0:e.data)==null?void 0:a.id;return t&&t.toString().trim()||null}function xo(e,n){var a;return n?(((a=e==null?void 0:e.data)==null?void 0:a.id)||"").toString().trim()===n?!0:((e==null?void 0:e.apicurioVersions)||[]).some(s=>{var r;return(((r=s==null?void 0:s.data)==null?void 0:r.id)||"").toString().trim()===n}):!1}function ja(e,{excludeIndex:n=-1}={}){if(!e)return-1;const t=e.toString().trim();if(!t)return-1;for(let i=0;i<S.length;i+=1){if(i===n)continue;const a=S[i];if(xo(a,t))return i}return-1}function qa(e){var d;if(e<0||e>=S.length||!c)return!0;const n=S[e],t=(c.value||"").trim();if(!t)return!0;let i;try{i=JSON.parse(t)}catch{return alert("Current JSON is invalid. Fix it before switching versions."),!1}lt(i,{titleHint:Oe(n),idHint:Je(n)});const a=fi(n.data),s=fi(i);if(a===s)return!0;n.data=i;const r=pt(n);return r>=0&&((d=n.apicurioVersions)!=null&&d[r])&&(n.apicurioVersions[r].data=i),!0}function Wa(e){const n=new Set;return((e==null?void 0:e.categories)||[]).forEach(t=>(t.items||[]).forEach(i=>{i!=null&&i.id&&n.add(i.id)})),n}function Ga(e){if(w<0||!e)return null;const n=S[w].data,t=(n==null?void 0:n.categories)||[];for(const i of t){const s=(i.items||[]).find(r=>r.id===e);if(s)return{category:i,item:s,modelData:n}}return null}function Ao(e,n){const t=Wa(n);let i=jt(e||"item");if(!t.has(i))return i;const a=()=>rt().slice(0,4);for(;t.has(i);)i=`${jt(e||"item")}-${a()}`;return i}function To(e="category",n){const t=(n==null?void 0:n.categories)||[],i=jt(e||"category"),a=d=>t.some(p=>p.id===d);let s=i||`category-${rt()}`;if(!a(s))return s;let r=t.length+1;for(;a(`${i}-${r}`);)r+=1;return`${i}-${r}`}const ct=Gl({findItemAndCategoryById:Ga,collectAllItemIds:Wa,updateItemReferences:Wl,loadActiveIntoEditor:cn,rebuildFromActive:rn,select:e=>dn(e),onSelectionRenamed:(e,n)=>{var t;L===e&&(L=n,sn()),((t=Ye==null?void 0:Ye.item)==null?void 0:t.id)===e&&(Ye.item.id=n)}});function Lo({getActiveModelData:e,loadActiveIntoEditor:n,rebuildFromActive:t,selectCategory:i,onCategoryRenamed:a}){const s={wrapper:null,fields:{},categoryId:null,modelData:null},r=x=>{if(s.fields.errorEl){if(!x){s.fields.errorEl.hidden=!0,s.fields.errorEl.textContent="";return}s.fields.errorEl.hidden=!1,s.fields.errorEl.textContent=x}},d=()=>{s.wrapper&&(s.wrapper.hidden=!0,s.wrapper.setAttribute("aria-hidden","true"),r(""),s.categoryId=null,s.modelData=null,document.body.classList.remove("category-editor-open"))},p=()=>{s.wrapper&&(s.wrapper.hidden=!1,s.wrapper.setAttribute("aria-hidden","false"),document.body.classList.add("category-editor-open"),requestAnimationFrame(()=>{var x,D;(x=s.fields.titleInput)==null||x.focus(),(D=s.fields.titleInput)==null||D.select()}))},g=()=>{if(!s.modelData||!s.categoryId)throw new Error("No category loaded.");const x=s.modelData.categories||[],D=x.find(Le=>Le.id===s.categoryId);if(!D)throw new Error("Category not found.");const ce=(s.fields.idInput.value||"").trim();if(!ce)throw new Error("ID is required.");const ye=(s.fields.titleInput.value||"").trim();if(x.some(Le=>Le.id===ce&&Le.id!==D.id))throw new Error("Another category already uses that ID.");const xe=D.id;return D.id=ce,D.title=ye||D.id,xe!==ce&&typeof a=="function"&&a(xe,ce),n(),t(),i(ce,{scrollIntoView:!0}),!0},v=()=>{try{return g(),d(),!0}catch(x){return console.warn("[CategoryEditor] save failed",x),r((x==null?void 0:x.message)||"Unable to save category."),!1}},A=()=>{if(s.wrapper)return s.wrapper;const x=document.createElement("div");x.className="item-editor-modal category-editor-modal",x.hidden=!0,x.setAttribute("role","dialog"),x.setAttribute("aria-modal","true");const D=document.createElement("div");D.className="item-editor-modal__backdrop",x.appendChild(D);const ce=document.createElement("div");ce.className="item-editor",x.appendChild(ce);const ye=document.createElement("div");ye.className="item-editor__header";const Ie=document.createElement("h2");Ie.className="item-editor__title",Ie.textContent="Edit category";const xe=document.createElement("button");xe.type="button",xe.className="item-editor__close",xe.setAttribute("aria-label","Close category editor"),xe.textContent="×",ye.appendChild(Ie),ye.appendChild(xe),ce.appendChild(ye);const Le=document.createElement("form");Le.className="item-editor__form",ce.appendChild(Le);const In=document.createElement("div");In.className="item-editor__meta",In.innerHTML='<div class="item-editor__meta-label">Category</div><div class="item-editor__meta-value"></div>',Le.appendChild(In);const Me=document.createElement("div");Me.className="item-editor__error",Me.hidden=!0,Le.appendChild(Me);const Pe=(Sn,ze,xt)=>{const Tn=document.createElement("label");Tn.className="item-editor__field";const mt=document.createElement("span");if(mt.className="item-editor__label",mt.textContent=Sn,Tn.appendChild(mt),ze.classList.add("item-editor__control"),Tn.appendChild(ze),xt){const ai=document.createElement("div");ai.className="item-editor__hint",ai.textContent=xt,Tn.appendChild(ai)}return Tn},xn=document.createElement("input");xn.type="text",Le.appendChild(Pe("Title",xn,"Display label shown in the map."));const ut=document.createElement("input");ut.type="text",ut.required=!0,Le.appendChild(Pe("ID",ut,"Unique identifier for this category (used in URLs and references)."));const et=document.createElement("div");et.className="item-editor__actions";const An=document.createElement("button");An.type="submit",An.className="item-editor__action item-editor__action--primary",An.textContent="Save";const Hn=document.createElement("button");return Hn.type="button",Hn.className="item-editor__action",Hn.textContent="Cancel",et.appendChild(An),et.appendChild(Hn),Le.appendChild(et),Le.addEventListener("submit",Sn=>{Sn.preventDefault(),v()}),Hn.addEventListener("click",d),xe.addEventListener("click",d),D.addEventListener("click",d),x.addEventListener("keydown",Sn=>{Sn.key==="Escape"&&(Sn.preventDefault(),d())}),document.body.appendChild(x),s.wrapper=x,s.fields={titleInput:xn,idInput:ut,errorEl:Me,metaLabel:In.querySelector(".item-editor__meta-value")},x};return{open:x=>{if(!x||!A())return!1;const ce=e(),Ie=((ce==null?void 0:ce.categories)||[]).find(xe=>xe.id===x);return Ie?(s.categoryId=Ie.id,s.modelData=ce,s.fields.metaLabel.textContent=Ie.title||Ie.id||"Category",s.fields.titleInput.value=Ie.title||Ie.id||"",s.fields.idInput.value=Ie.id||"",r(""),p(),!0):!1},hide:d,isOpen:()=>!!s.wrapper&&s.wrapper.hidden===!1}}const No=Lo({getActiveModelData:()=>{var e;return(e=S[w])==null?void 0:e.data},loadActiveIntoEditor:cn,rebuildFromActive:rn,selectCategory:(e,n={})=>$n(e,n),onCategoryRenamed:(e,n)=>{z===e&&(z=n,sn())}});function hi(e,{versionLabel:n="1",createdOn:t}={}){if(!e)return e;if(Array.isArray(e.apicurioVersions)&&e.apicurioVersions.length)return e.apicurioActiveVersionIndex==null&&(e.apicurioActiveVersionIndex=0),!e.data&&e.apicurioVersions[e.apicurioActiveVersionIndex]&&(e.data=e.apicurioVersions[e.apicurioActiveVersionIndex].data),e;const i={version:n,data:e.data,createdOn:t||new Date().toISOString()};e.apicurioVersions=[i],e.apicurioActiveVersionIndex=0;const a=e.title||Oe(e);return gn(e,{seriesName:a,fallbackTitle:a}),e.isSeries=!0,e}function Wn(e,{versionLabel:n,createdOn:t}={}){var p,g,v;if(e!=null&&e.isSeries||((p=e==null?void 0:e.apicurioVersions)==null?void 0:p.length)>1){const A=e.title||Oe(e);gn(e,{seriesName:A,fallbackTitle:A})}const i=Je(e);if(!i)return hi(e,{versionLabel:n||"1",createdOn:t}),S.push(e),S.length-1;const a=S.findIndex(A=>Je(A)===i);if(a===-1)return hi(e,{versionLabel:n||"1",createdOn:t}),S.push(e),S.length-1;const s=S[a];if(!Array.isArray(s.apicurioVersions)||!s.apicurioVersions.length){s.apicurioVersions=[{version:"1",data:s.data,createdOn:(v=(g=s.apicurioVersions)==null?void 0:g[0])==null?void 0:v.createdOn}],s.apicurioActiveVersionIndex=0;const A=s.title||Oe(s);gn(s,{seriesName:A,fallbackTitle:A})}const r=String(s.apicurioVersions.length+1);s.apicurioVersions.push({version:r,data:e.data,createdOn:t||new Date().toISOString()}),s.apicurioActiveVersionIndex=s.apicurioVersions.length-1,s.data=e.data,s.title=Oe(e)||s.title,s.isSeries=!0;const d=s.title||Oe(s);return gn(s,{seriesName:d,fallbackTitle:d}),a}function Ja({versionLabel:e}={}){var r;if(w<0||!S[w])throw new Error("Load or select a model before creating a version.");const n=S[w];hi(n,{versionLabel:"1"});let t;try{t=Io(n.data)}catch(d){throw console.warn("[Blockscape] failed to clone active model for versioning",d),new Error("Could not copy the current model.")}lt(t,{titleHint:Oe(n),idHint:Je(n)||Nt(n)});const a={version:e||String((((r=n.apicurioVersions)==null?void 0:r.length)||0)+1),data:t,createdOn:new Date().toISOString()};n.apicurioVersions.push(a),n.apicurioActiveVersionIndex=n.apicurioVersions.length-1,n.data=t,n.isSeries=!0;const s=n.title||Oe(n);return gn(n,{seriesName:s,fallbackTitle:s}),w}function bi(){const e=w>=0&&S[w]?S[w]:null,n=Je(e);document.title=n?`${n}-blockscape`:qe}function Ui(e){if(!e)return null;const n=e.apicurioVersions;if(!Array.isArray(n)||n.length<=1)return null;const t=e.title||e.apicurioArtifactName||Oe(e);return gn(e,{seriesName:t,fallbackTitle:t}),n.map(i=>i&&typeof i=="object"&&"data"in i?i.data:i)}function Mo(){const e=S[w],n=Ui(e);if(!n)return null;try{return JSON.stringify(n,null,2)}catch(t){return console.warn("[Blockscape] failed to stringify series",t),null}}function za(e="shortcut",n=!1){const t=c.value||"";if(!t.trim())return console.warn("[Blockscape] download ignored: JSON box is empty."),!1;const i=S[w],a=n?Ui(i):null,s=!!a,r=s?JSON.stringify(a,null,2):t,d=Nt(i),p=Je(i),g=d||p||Oe(i,"blockscape"),v=s?"-series":"",A=`${jt(g)}${v}.bs`;return Ks(A,r),console.log(`[Blockscape] saved JSON (${e}):`,A),!0}const Po={A:"#0284c7",B:"#3b82f6",C:"#06b6d4",D:"#a855f7",E:"#f59e0b",F:"#f97316",G:"#22c55e",H:"#84cc16",I:"#10b981",J:"#14b8a6",K:"#0ea5e9",L:"#60a5fa",M:"#8b5cf6",N:"#d946ef",O:"#e879f9",P:"#67e8f9",Q:"#4ade80",R:"#facc15",S:"#eab308",T:"#a3e635",U:"#22d3ee",V:"#38bdf8",W:"#818cf8",X:"#a78bfa",Y:"#f472b6",Z:"#fb7185"};function Ka(e,n){if(n&&/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(n))return n;const t=(e||"?").charAt(0).toUpperCase();return Po[t]||"#9ca3af"}function Ro(e){const n=e.replace("#",""),t=n.length===3?n.split("").map(p=>p+p).join(""):n,i=parseInt(t,16),a=i>>16&255,s=i>>8&255,r=i&255;return .2126*Math.pow(a/255,2.2)+.7152*Math.pow(s/255,2.2)+.0722*Math.pow(r/255,2.2)>.35?"#111111":"#ffffff"}function Bo(){if(!(typeof window>"u"||typeof window.scrollTo!="function"))try{window.scrollTo({top:0,behavior:"smooth"})}catch{window.scrollTo(0,0)}}function Vi(){if(Cn)return;Cn=document.createElement("div"),Cn.className="series-nav-notice";const e=document.createElement("span");e.className="series-nav-notice__dot",yn=document.createElement("span"),yn.className="series-nav-notice__text",Cn.appendChild(e),Cn.appendChild(yn),document.body.appendChild(Cn)}function $i(){En&&(clearTimeout(En),En=null),Cn&&Cn.classList.remove("is-visible"),yn&&(yn.textContent="")}function Qn(){Fn=null,Un=null,bn&&(clearTimeout(bn),bn=null),vn&&(clearTimeout(vn),vn=null),$i()}function Do(e,n){var i;if(!((i=e==null?void 0:e.apicurioVersions)!=null&&i[n]))return`version ${n+1}`;const t=e.apicurioVersions[n].version;return t?`version "${t}"`:`version ${n+1}`}function Oo(e,n,t){Vi(),Fn={id:e,targetVersionIndex:n},bn&&clearTimeout(bn),bn=setTimeout(()=>{bn=null,Qn()},Kn);const i=Do(t,n);vi(`Click again to open ${i} in this series.`,Kn)}function Uo(e,n,t){Vi(),Un={id:e,targetModelIndex:n},vn&&clearTimeout(vn),vn=setTimeout(()=>{vn=null,Un=null,$i()},Kn);const i=gi(t)||e;vi(`Click again to open "${i}" from the portfolio.`,Kn)}function vi(e,n=pi,t=null){if(Vi(),yn.textContent="",yn.appendChild(document.createTextNode(e)),t){const i=document.createTextNode(" "),a=document.createElement("a");a.href=t,a.target="_blank",a.rel="noopener",a.textContent=t,yn.appendChild(i),yn.appendChild(a)}Cn.classList.add("is-visible"),En&&clearTimeout(En),En=setTimeout(()=>$i(),n)}function Vo(){le&&(le.innerHTML="",_o.forEach(e=>{const n=document.createElement("div");n.className="shortcut-help__row";const t=document.createElement("div");t.className="shortcut-help__keys",e.keys.forEach((a,s)=>{if(s>0){const d=document.createElement("span");d.className="shortcut-help__or",d.textContent="or",t.appendChild(d)}const r=document.createElement("div");r.className="shortcut-help__combo",a.forEach((d,p)=>{if(p>0){const v=document.createElement("span");v.className="shortcut-help__sep",v.textContent="+",r.appendChild(v)}const g=document.createElement("kbd");g.className="shortcut-help__key",g.textContent=d,r.appendChild(g)}),t.appendChild(r)});const i=document.createElement("div");i.className="shortcut-help__desc",i.textContent=e.description,n.appendChild(t),n.appendChild(i),le.appendChild(n)}),Ne=!0)}function $o(){return!!te&&te.hidden===!1}function Ho(){if(!te)return;Ne||Vo(),Bt=document.activeElement,te.hidden=!1,te.setAttribute("aria-hidden","false"),document.body.classList.add("shortcut-help-open");const e=te.querySelector(".shortcut-help__panel");e==null||e.focus({preventScroll:!0})}function Hi(){if(!te||te.hidden)return;te.hidden=!0,te.setAttribute("aria-hidden","true"),document.body.classList.remove("shortcut-help-open");const e=Bt;e!=null&&e.focus?e.focus({preventScroll:!0}):pe!=null&&pe.focus&&pe.focus({preventScroll:!0})}function Fo(){if(!ve)return;ve.hidden=!1,ve.setAttribute("aria-hidden","false"),document.body.classList.add("shortcut-help-open");const e=ve.querySelector(".shortcut-help__panel");e==null||e.focus({preventScroll:!0})}function Fi(){!ve||ve.hidden||(ve.hidden=!0,ve.setAttribute("aria-hidden","true"),document.body.classList.remove("shortcut-help-open"),fe!=null&&fe.focus&&fe.focus({preventScroll:!0}))}let ji=!1;function Zt(){ji||(ji=!0,requestAnimationFrame(()=>{ji=!1,Ji(),Et()}))}let Qa=!1;function Xa(e){return(e||"").toString().toLowerCase().split(/\s+/).map(n=>n.trim()).filter(Boolean)}function jo(e){const n=Xa(e);if(!n.length){C.querySelectorAll(".tile").forEach(t=>{t.style.opacity=""});return}C.querySelectorAll(".tile").forEach(t=>{var r;const i=(((r=t.querySelector(".name"))==null?void 0:r.textContent)||"").toLowerCase(),a=(t.dataset.id||"").toLowerCase(),s=n.every(d=>i.includes(d)||a.includes(d));t.style.opacity=s?"1":"0.2"})}function qo(e){const n=Xa(e);if(!n.length)return[];const t=[];return S.forEach((i,a)=>{var g;const s=gi(i),r=Je(i)||"",d=`${s} ${r}`.toLowerCase();n.every(v=>d.includes(v))&&t.push({type:"model",modelIndex:a,modelTitle:s,modelId:r}),(Array.isArray((g=i.data)==null?void 0:g.categories)?i.data.categories:[]).forEach(v=>{const A=(v.title||v.id||"").toString();(v.items||[]).forEach(I=>{const x=(I.name||I.id||"").toString(),D=`${x} ${I.id||""} ${A}`.toLowerCase();n.every(ce=>D.includes(ce))&&t.push({type:"item",modelIndex:a,modelTitle:s,modelId:r,itemId:I.id,itemName:x,categoryTitle:A})})})}),t.slice(0,l)}function Ya(e){if(!Q)return;Q.innerHTML="";const n=(e||"").toString();if(!n.trim()){Q.hidden=!0;return}if(!S.length){const i=document.createElement("div");i.className="search-results__empty",i.textContent="Load models to search",Q.appendChild(i),Q.hidden=!1;return}const t=qo(n);if(!t.length){const i=document.createElement("div");i.className="search-results__empty",i.textContent="No matches yet",Q.appendChild(i),Q.hidden=!1;return}t.forEach(i=>{const a=document.createElement("button");a.type="button",a.className="search-result",a.dataset.modelIndex=String(i.modelIndex),i.itemId&&(a.dataset.itemId=i.itemId),i.type&&(a.dataset.type=i.type),i.modelIndex===w&&(!i.itemId||L===i.itemId)&&a.classList.add("is-active");const s=document.createElement("div");s.className="search-result__primary";const r=document.createElement("span");r.textContent=i.type==="model"?i.modelTitle:i.itemName||i.itemId||"Item",s.appendChild(r);const d=document.createElement("span");d.className="search-result__badge",d.textContent=i.type==="item"?i.categoryTitle||"Item":"Model",s.appendChild(d);const p=document.createElement("div");p.className="search-result__meta";const g=document.createElement("span");if(g.textContent=i.modelId?`${i.modelTitle} · ${i.modelId}`:i.modelTitle,p.appendChild(g),i.type==="item"&&i.itemId){const v=document.createElement("span");v.textContent=`Item ID: ${i.itemId}`,p.appendChild(v)}else if(i.type==="model"){const v=document.createElement("span");v.textContent="Matches model title",p.appendChild(v)}a.appendChild(s),a.appendChild(p),Q.appendChild(a)}),Q.hidden=!1}function qi(e){jo(e||""),Ya(e||"")}function Wo(e){!e||!Number.isInteger(e.modelIndex)||(Ze(e.modelIndex),e.itemId&&requestAnimationFrame(()=>{var t;if(w!==e.modelIndex)return;const n=(t=be.get(e.itemId))==null?void 0:t.el;n&&(dn(e.itemId),n.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),n.focus({preventScroll:!0}))}))}function Ze(e){if(kn(),Qn(),Ye=null,ie=null,z=null,he=null,e<0||e>=S.length){console.warn("[Blockscape] setActive called with out-of-range index:",e);return}at=!0,w=e,console.log("[Blockscape] active model:",Oe(S[e]),"(index",e+" )"),bi(),Xn(),cn(),rn(),R&&qi(R.value||""),_e.updateAvailability()}function Xn(){if(j.innerHTML="",!S.length){const e=document.createElement("li");e.className="model-nav-empty",e.textContent="No models loaded yet.",j.appendChild(e);return}S.forEach((e,n)=>{var A;const t=document.createElement("li");t.className="model-nav-item";const i=document.createElement("button");i.type="button",i.className="model-nav-button"+(n===w?" is-active":""),i.dataset.index=String(n),i.setAttribute("aria-current",n===w?"true":"false");const a=document.createElement("span");a.className="model-nav-label";const s=document.createElement("span");s.className="model-nav-title",s.textContent=gi(e),a.appendChild(s);const r=Je(e);if(r){const I=document.createElement("span");I.className="model-nav-id",I.textContent=r,a.appendChild(I)}const d=Array.isArray((A=e.data)==null?void 0:A.categories)?e.data.categories:[],p=d.reduce((I,x)=>I+(x.items||[]).length,0),g=document.createElement("span");g.className="model-nav-meta";const v=e.apicurioVersions&&e.apicurioVersions.length>1?` · ${e.apicurioVersions.length} maps`:"";g.textContent=`${d.length} cat · ${p} items${v}`,i.appendChild(a),i.appendChild(g),t.appendChild(i),j.appendChild(t)}),_e.updateAvailability()}function cn(){if(w<0){c.value="",Se&&(Se.disabled=!0);return}const e=S[w];c.value=JSON.stringify(e.data,null,2),Se&&(Se.disabled=!Ui(e))}function Go(e){try{return JSON.parse(e)}catch{return null}}function Jo(e,n="Pasted",t={}){const i=Array.isArray(e)?e:[];if(!i.length)return[];const a=i.map((v,A)=>!v||typeof v!="object"?null:(lt(v,{titleHint:`${n} #${A+1}`}),{obj:v,idx:A})).filter(Boolean);if(!a.length)return[];const s=a[0].obj,{seriesTitleOverride:r}=t;let d=r||s.title||`${n} series`;r&&!s.title&&(s.title=r);const p={id:rt(),title:d,data:s,apicurioVersions:a.map(({obj:v,idx:A})=>({version:String(A+1),data:v})),apicurioActiveVersionIndex:0,isSeries:!0},g=gn(p,{seriesName:d,fallbackTitle:d});return g&&(p.id=g),[p]}function Za(e,n="Pasted",t={}){return Array.isArray(e)?Jo(e,n,t):!e||typeof e!="object"?[]:(lt(e,{titleHint:`${n} #1`}),[{id:rt(),title:e.title||`${n} #1`,data:e}])}function Yn(e,n="Pasted",t={}){const i=(e||"").trim();if(!i)return[];const a=Go(i);if(a){let r=t;if(Array.isArray(a)&&t.promptForSeriesName){const p=Co(a,n),g=So(p);r={...t,promptForSeriesName:!1,seriesTitleOverride:g||p}}const d=Za(a,n,r);if(d.length)return d}return i.split(/^\s*(?:---|%%%)\s*$/m).map(r=>r.trim()).filter(Boolean).map((r,d)=>{const p=JSON.parse(r);return lt(p,{titleHint:`${n} #${d+1}`}),{id:rt(),title:p.title||`${n} #${d+1}`,data:p}})}function zo(e){if(!e)return!1;if(e.isContentEditable)return!0;const n=(e.tagName||"").toLowerCase();return n==="input"||n==="textarea"||n==="select"}function dt(){const e=document.activeElement;return!e||e===document.body||e===document.documentElement?!0:!zo(e)}function Ko(e){if(!e)return!1;const n=e.trimStart();return/^\s*(\{|\[|---|%%%)/.test(n)}function es(){if(typeof window>"u"||!window.localStorage)return null;let e;try{e=localStorage.getItem(Be)}catch(a){return console.warn("[Blockscape] failed to access editor payload",a),null}if(!e)return null;let n;try{n=JSON.parse(e)}catch(a){console.warn("[Blockscape] invalid payload JSON",a);try{localStorage.removeItem(Be)}catch{}return null}if((n==null?void 0:n.source)!=="editor")return null;try{localStorage.removeItem(Be)}catch(a){console.warn("[Blockscape] failed to clear editor payload",a)}if(!n.text||typeof n.text!="string")return console.warn("[Blockscape] payload missing text"),null;let t=[];try{t=Yn(n.text,n.title||"Editor Export")}catch(a){return console.warn("[Blockscape] could not parse payload text",a),null}if(!t.length)return null;let i=null;return t.forEach(a=>{const s=Wn(a,{versionLabel:"editor"});i==null&&(i=s)}),console.log(`[Blockscape] imported ${t.length} model(s) from editor`),{index:i,count:t.length}}function ns(e="storage"){const n=es();return!n||typeof n.index!="number"?!1:(Ze(n.index),console.log(`[Blockscape] imported ${n.count} model(s) from editor via ${e}.`),!0)}function Qo(){const e=window.location.hash||"";let n=null;const t=e.match(/share=([^&]+)/);if(t&&(n=t[1]),!n){const r=new URLSearchParams(window.location.search);r.has("share")&&(n=r.get("share"))}if(!n)return null;let i;try{const r=zs(n);i=JSON.parse(r)}catch(r){return console.warn("[Blockscape] failed to decode share token",r),null}if(!i||typeof i!="object"||i.data==null)return console.warn("[Blockscape] share payload missing data"),null;const a=Za(i.data,i.title||"Shared Model");if(!a.length)return console.warn("[Blockscape] share payload did not contain usable models"),null;let s=null;return a.forEach(r=>{const d=r.isSeries?i.title||r.title:null,p=Wn({...r,apicurioArtifactName:d||r.apicurioArtifactName},{versionLabel:"shared"});s==null&&(s=p)}),s}async function Xo(){const e=window.location.hash||"";let n=null;const t=e.match(/load=([^&]+)/);if(t)try{n=decodeURIComponent(t[1])}catch{n=t[1]}if(!n){const i=new URLSearchParams(window.location.search);i.has("load")&&(n=i.get("load"))}if(!n)return null;try{const i=await Xi(n);return typeof i=="number"?i:null}catch(i){return console.warn("[Blockscape] load param failed",i),null}}function Yo(e){console.log("[Blockscape] parsing model; categories=",((e==null?void 0:e.categories)||[]).length);const n=new Map,t=new Map,i=new Set;(e.categories||[]).forEach(s=>(s.items||[]).forEach(r=>{i.add(r.id);const d=new Set(r.deps||[]);(e.links||[]).forEach(p=>{p.from===r.id&&d.add(p.to)}),n.set(r.id,d),d.forEach(p=>{t.has(p)||t.set(p,new Set),t.get(p).add(r.id)})}));const a=new Set;return t.forEach((s,r)=>{((s==null?void 0:s.size)||0)>=2&&a.add(r)}),{m:e,fwd:n,rev:t,reusedLocal:a,seen:i}}function Zo(e,n){console.log("[Blockscape] generateLetterImage for:",e);const t=document.createElement("canvas"),i=44;t.width=i,t.height=i;const a=t.getContext("2d"),s=(e||"?").charAt(0).toUpperCase(),r=Ka(e,n),d=Ro(r);return a.fillStyle=r,a.beginPath(),a.arc(i/2,i/2,i/2-2,0,2*Math.PI),a.fill(),a.strokeStyle="rgba(0,0,0,0.15)",a.lineWidth=1,a.stroke(),a.fillStyle=d,a.font=`bold ${i*.5}px system-ui, -apple-system, sans-serif`,a.textAlign="center",a.textBaseline="middle",a.fillText(s,i/2,i/2),t.toDataURL("image/png")}function pt(e){var t;if(!((t=e==null?void 0:e.apicurioVersions)!=null&&t.length))return-1;const n=Number.isInteger(e.apicurioActiveVersionIndex)?e.apicurioActiveVersionIndex:0;return Math.min(Math.max(n,0),e.apicurioVersions.length-1)}function ts(e){const n=pt(e);if(n===-1)return null;const t=e.apicurioVersions[n];return(t==null?void 0:t.version)??null}function er(e){const n=new Map;return((e==null?void 0:e.apicurioVersions)||[]).forEach((t,i)=>{var r,d;const a=(((r=t==null?void 0:t.data)==null?void 0:r.id)??"").toString().trim();a&&n.set(a,i);const s=(((d=t==null?void 0:t.data)==null?void 0:d.seriesId)??"").toString().trim();s&&!n.has(s)&&n.set(s,i)}),n}const is=new WeakMap;function nr(e,n){var Ie;if(!((Ie=e==null?void 0:e.apicurioVersions)!=null&&Ie[n]))return null;const t=e.apicurioVersions[n],i=t.data,a=fi(i),s=is.get(t);if(s&&s.fingerprint===a)return s.dataUrl;const r=160,d=90,p=document.createElement("canvas");p.width=r,p.height=d;const g=p.getContext("2d");g.fillStyle="#f8fafc",g.fillRect(0,0,r,d),g.strokeStyle="#e5e7eb",g.strokeRect(.5,.5,r-1,d-1);const v=Array.isArray(i==null?void 0:i.categories)?i.categories:[],A=Math.max(v.length,1),I=r/A,x=8,D=8,ce=4;v.forEach((xe,Le)=>{const In=Le*I+I/2,Me=Array.isArray(xe.items)?xe.items:[],Pe=Math.max(Me.length,1);Me.forEach((xn,ut)=>{const et=x+(ut+.5)*((d-x-D)/Pe);g.beginPath(),g.arc(In,et,ce,0,Math.PI*2);const An=Ka(xn.name||xn.id||"",xn.color);g.fillStyle=An,g.strokeStyle="rgba(15,23,42,0.25)",g.fill(),g.stroke()})});const ye=p.toDataURL("image/png");return is.set(t,{fingerprint:a,dataUrl:ye}),ye}function Wi(e,n){var d;if(Qn(),e<0||e>=S.length)return!1;const t=S[e];if(!((d=t==null?void 0:t.apicurioVersions)!=null&&d.length)||!qa(e))return!1;const a=t.apicurioVersions.length,s=(n%a+a)%a,r=t.apicurioVersions[s];return r!=null&&r.data?(t.apicurioActiveVersionIndex=s,t.data=r.data,at=!0,L=null,ne=null,sn(),cn(),rn(),!0):!1}function Gi(e){var i;if(!e||w<0)return!1;const n=S[w];if(!((i=n==null?void 0:n.apicurioVersions)!=null&&i.length))return!1;const t=pt(n);return t===-1?!1:Wi(w,t+e)}function tr(e,n){if(Qn(),e<0||e>=S.length)return!1;const t=S[e];if(!Array.isArray(t==null?void 0:t.apicurioVersions)||t.apicurioVersions.length<=1)return alert("A series needs at least one map. Add another before removing this one."),!1;if(!qa(e))return!1;const i=Math.min(Math.max(n,0),t.apicurioVersions.length-1),a=pt(t),[s]=t.apicurioVersions.splice(i,1);if(!s)return!1;let r=a;i===a?r=Math.min(i,t.apicurioVersions.length-1):i<a&&(r=Math.max(0,a-1)),t.apicurioActiveVersionIndex=Math.max(0,r);const d=t.apicurioVersions[t.apicurioActiveVersionIndex];return t.data=(d==null?void 0:d.data)||t.data,t.isSeries=t.apicurioVersions.length>1,Ze(e),!0}function ir(e){if(!(e!=null&&e.apicurioVersions)||!e.apicurioVersions.length)return null;const n=document.createElement("div");n.className="version-nav";const t=document.createElement("div");t.className="version-nav__title",t.textContent=e.apicurioArtifactName||e.apicurioArtifactId||Je(e)||"Artifact",t.title="Double-click to rename this series",t.setAttribute("role","button"),t.tabIndex=0,t.addEventListener("dblclick",()=>{var D;const I=S[w];!((D=I==null?void 0:I.apicurioVersions)!=null&&D.length)||!Eo(I)||(Xn(),cn(),rn())}),n.appendChild(t);const i=document.createElement("div");i.className="version-nav__status";const a=pt(e),s=ts(e)||"latest";i.textContent=`No. in series ${s} (${a+1} of ${e.apicurioVersions.length})`,n.appendChild(i);const r=document.createElement("div");r.className="version-nav__controls";const d=document.createElement("button");d.type="button",d.className="version-nav__button",d.textContent="Previous",d.addEventListener("click",()=>Gi(-1));const p=document.createElement("button");p.type="button",p.className="version-nav__button",p.textContent="Next",p.addEventListener("click",()=>Gi(1)),r.appendChild(d),r.appendChild(p),n.appendChild(r);const g=document.createElement("div");g.className="version-nav__thumbs",e.apicurioVersions.forEach((I,x)=>{var In;const D=document.createElement("button");D.type="button",D.className="version-nav__thumb",x===a&&D.classList.add("is-active");const ce=nr(e,x);if(ce){const Me=document.createElement("img");Me.src=ce,Me.alt=`Version ${x+1}`,D.appendChild(Me)}const ye=document.createElement("div");ye.className="version-nav__thumb-label";const Ie=document.createElement("span");Ie.className="version-nav__thumb-label-text";const xe=(((In=I==null?void 0:I.data)==null?void 0:In.id)??(I==null?void 0:I.id)??"").toString().trim(),Le=xe||(I!=null&&I.version?`v${I.version}`:`${x+1}`);if(Ie.textContent=Le,ye.title=xe||Le,ye.appendChild(Ie),D.appendChild(ye),pr(ye,Ie),e.apicurioVersions.length>1){const Me=document.createElement("span");Me.className="version-nav__thumb-remove",Me.title=`Remove ${Le} from this series`,Me.setAttribute("aria-label",`Remove ${Le} from this series`),Me.setAttribute("role","button"),Me.tabIndex=-1,Me.textContent="×",Me.addEventListener("click",Pe=>{Pe.stopPropagation(),Pe.preventDefault(),window.confirm(`Remove ${Le} from this series?`)&&tr(w,x)}),D.appendChild(Me)}D.addEventListener("click",()=>Wi(w,x)),mr(D,I),g.appendChild(D)});const v=document.createElement("button");v.type="button",v.className="version-nav__thumb version-nav__thumb--add",v.title="Create a new version from this map",v.addEventListener("click",()=>{try{const I=Ja({versionLabel:"manual"});Ze(I)}catch(I){alert((I==null?void 0:I.message)||"Unable to create a new version right now.")}});const A=document.createElement("span");return A.className="version-nav__thumb-add-icon",A.textContent="+",v.appendChild(A),g.appendChild(v),n.appendChild(g),n}function St(){var _s,Is,xs;if(!V)return;Gn(),Array.isArray(V.m.categories)||(V.m.categories=[]),console.log("[Blockscape] rendering categories=",V.m.categories.length),console.log("[Blockscape] model.m has abstract?",!!V.m.abstract,"- value:",V.m.abstract?V.m.abstract.substring(0,50)+"...":"none"),C.innerHTML="",be.clear(),Ke.clear(),zn=[],hi(S[w],{versionLabel:"1"});const e=ir(S[w]);e&&C.appendChild(e),k.setAttribute("width",window.innerWidth),k.setAttribute("height",window.innerHeight);const n=document.createElement("div");n.className="blockscape-model-meta";const t=document.createElement("div");t.className="blockscape-model-title",t.textContent=V.m.title&&V.m.title.trim()||Oe(S[w]),n.appendChild(t),((_s=S[w])!=null&&_s.isSeries||(xs=(Is=S[w])==null?void 0:Is.apicurioVersions)!=null&&xs.length)&&gn(S[w],{seriesName:S[w].title||V.m.title||Oe(S[w])});const i=ts(S[w]),a=Nt(S[w]),s=(V.m.id??"").toString().trim(),r=document.createElement("div");r.className="blockscape-model-meta__details";const d=(b,K)=>{if(!K)return;const O=document.createElement("div");O.className="blockscape-model-id";const Ce=document.createElement("span");Ce.className="blockscape-model-id__label",Ce.textContent=b;const Qe=document.createElement("span");Qe.className="blockscape-model-id__value",Qe.textContent=K,O.append(Ce,Qe),r.appendChild(O)};d("Series ID",a),d("Model ID",s),d("No. in series",i),r.childElementCount&&n.appendChild(r),C.appendChild(n);const p=document.createElement("div");p.className="blockscape-tabs";const g=document.createElement("div");g.className="blockscape-tablist",g.setAttribute("role","tablist"),p.appendChild(g);const v=document.createElement("div");v.className="blockscape-tabpanels",p.appendChild(v);const A=document.createElement("div"),I=document.createElement("div"),x=document.createElement("div"),D=document.createElement("div");let ce="";const ye=er(S[w]),Ie=pt(S[w]);jn=null,wt="";const xe=[{id:"map",label:"Map",panel:A},{id:"abstract",label:"Info",panel:I},{id:"source",label:"Settings",panel:x},{id:"apicurio",label:"Apicurio",panel:D}],Le=typeof _e.isEnabled=="function"?_e.isEnabled():!1,In=b=>{if(!k)return;const K=b==="map";k.hidden=!K,K?(Ji(),Et()):k.innerHTML=""};xe.forEach((b,K)=>{const O=document.createElement("button");O.type="button",O.id=`tab-${b.id}`,O.className="blockscape-tab"+(K===0?" is-active":""),O.setAttribute("role","tab"),O.setAttribute("aria-controls",`panel-${b.id}`),O.setAttribute("aria-selected",K===0?"true":"false"),O.textContent=b.label,b.id==="apicurio"&&!Le&&(O.hidden=!0,O.tabIndex=-1,O.setAttribute("aria-hidden","true"),O.style.display="none"),b.button=O,g.appendChild(O),b.panel.id=`panel-${b.id}`,b.panel.classList.add("blockscape-tabpanel"),b.panel.setAttribute("role","tabpanel"),b.panel.setAttribute("aria-labelledby",O.id),b.panel.hidden=K!==0,K===0&&b.panel.classList.add("is-active"),v.appendChild(b.panel)});const Me=b=>{On=b,xe.forEach(K=>{const O=K.id===b;K.button.classList.toggle("is-active",O),K.button.setAttribute("aria-selected",O?"true":"false"),K.panel.classList.toggle("is-active",O),K.panel.hidden=!O}),In(b)},Pe=xe.find(b=>b.id==="apicurio"),xn=b=>{if(!Pe||!Pe.button||!Pe.panel)return;const K=!!b;if(Pe.button.hidden=!K,Pe.button.tabIndex=K?0:-1,Pe.button.setAttribute("aria-hidden",K?"false":"true"),Pe.button.style.display=K?"":"none",K){const O=On==="apicurio";Pe.button.classList.toggle("is-active",O),Pe.button.setAttribute("aria-selected",O?"true":"false"),Pe.panel.classList.toggle("is-active",O),Pe.panel.hidden=!O}else{const O=Pe.panel.classList.contains("is-active");if(Pe.button.classList.remove("is-active"),Pe.button.setAttribute("aria-selected","false"),Pe.panel.classList.remove("is-active"),Pe.panel.hidden=!0,O){const Ce=xe.find(Qe=>Qe.id!=="apicurio");Ce&&Me(Ce.id)}}Dt&&(Dt.checked=K)};xe.forEach(b=>{b.button.addEventListener("click",()=>{Gn(),Me(b.id)}),b.id==="abstract"&&(jn=b.button,b.button.addEventListener("mouseenter",()=>ti(b.button,ce,{offset:12})),b.button.addEventListener("mouseleave",Gn),b.button.addEventListener("focus",()=>ti(b.button,ce,{offset:12})),b.button.addEventListener("blur",Gn))});const et=(b=>{const K=xe.find(Ce=>Ce.id===On);if(K&&(K.id!=="apicurio"||b))return K.id;const O=xe.find(Ce=>Ce.id!=="apicurio"||b);return(O==null?void 0:O.id)||xe[0].id})(Le);Me(et),xn(Le),typeof _e.onEnabledChange=="function"&&_e.onEnabledChange(xn),C.appendChild(p);const An=document.createElement("div");An.className="blockscape-render",A.appendChild(An);const Hn=document.createElement("div");if(Hn.className="blockscape-abstract-panel",V.m.abstract){console.log("[Blockscape] Rendering abstract content");const b=document.createElement("div");b.className="blockscape-abstract",b.innerHTML=V.m.abstract,Fr(b),Hn.appendChild(b),ce=b.outerHTML}else{console.log("[Blockscape] No abstract found in model.m");const b=document.createElement("div");b.className="blockscape-abstract-placeholder",b.textContent="No abstract has been provided for this model.",Hn.appendChild(b),ce=b.outerHTML}wt=ce,I.appendChild(Hn);const Sn=document.createElement("div");Sn.className="blockscape-source-panel";const ze=document.createElement("div");ze.className="blockscape-settings-panel";const xt=document.createElement("p");xt.className="blockscape-settings-panel__title",xt.textContent="Feature toggles",ze.appendChild(xt);const Tn=({id:b,label:K,hint:O,checked:Ce,className:Qe="",onChange:Ee})=>{const Bn=document.createElement("label");Bn.className=["settings-toggle",Qe].filter(Boolean).join(" ");const Dn=document.createElement("input");Dn.type="checkbox",Dn.id=b,Dn.checked=Ce;const ft=document.createElement("span");ft.className="settings-toggle__text";const tt=document.createElement("span");if(tt.className="settings-toggle__label",tt.textContent=K,ft.appendChild(tt),O){const oi=document.createElement("span");oi.className="settings-toggle__hint",oi.textContent=O,ft.appendChild(oi)}return Bn.appendChild(Dn),Bn.appendChild(ft),typeof Ee=="function"&&Dn.addEventListener("change",()=>Ee(Dn.checked)),{row:Bn,input:Dn}},mt=()=>{C.querySelectorAll(".tile").forEach(b=>{const K=b.dataset.id,O=Ga(K);if(!(O!=null&&O.item))return;const Ce=ls(O.item.external),Qe=rs(O.item,{externalMeta:Ce,seriesIdLookup:ye});cs(b,Qe)})},{row:ai}=Tn({id:"toggleSecondaryLinks",label:"Show indirect links",checked:pn,className:"map-controls__toggle",onChange:b=>{pn=b,L?dn(L):(Ki(),Et())}});ze.appendChild(ai);const{row:Gr}=Tn({id:"toggleReusedInMap",label:"Display reused in map view",hint:"Show markers for nodes used multiple times.",checked:hn,className:"map-controls__toggle",onChange:b=>{hn=b,ss()}});ze.appendChild(Gr);const bs=[],{row:Jr}=Tn({id:"toggleObsidianLinks",label:"Obsidian",hint:"Make tiles open Obsidian when no external URL exists.",checked:$t,className:"map-controls__toggle",onChange:b=>{const K=Xt(b);vo(K),bs.forEach(O=>{O.disabled=!K}),mt()}});ze.appendChild(Jr);const Yi=document.createElement("div");Yi.className="settings-radio";const Zi=document.createElement("div");Zi.className="settings-radio__label",Zi.textContent="Obsidian link format";const ea=document.createElement("div");ea.className="settings-radio__hint",ea.textContent="Use the tile title or id when building Obsidian links.";const na=document.createElement("div");na.className="settings-radio__options";const vs=(b,K)=>{const O=document.createElement("label");O.className="settings-radio__option";const Ce=document.createElement("input");Ce.type="radio",Ce.name="obsidianLinkMode",Ce.value=b,Ce.checked=ui===b,Ce.disabled=!$t,Ce.addEventListener("change",()=>{if(!Ce.checked)return;const Ee=Qt(b);ho(Ee),mt()});const Qe=document.createElement("span");Qe.textContent=K,O.append(Ce,Qe),bs.push(Ce),na.appendChild(O)};vs(_n,"Use title"),vs(ln,"Use id"),Yi.append(Zi,na,ea),ze.appendChild(Yi);const ki=document.createElement("label");ki.className="settings-text",ki.setAttribute("for","obsidianVaultInput");const ta=document.createElement("div");ta.className="settings-text__text";const ia=document.createElement("span");ia.className="settings-text__label",ia.textContent="Obsidian vault";const aa=document.createElement("span");aa.className="settings-text__hint",aa.textContent="Optional. Set the vault name to avoid duplicates.",ta.append(ia,aa);const nt=document.createElement("input");nt.type="text",nt.id="obsidianVaultInput",nt.className="settings-text__input",nt.placeholder="Vault name",nt.value=Ht,nt.addEventListener("input",()=>{const b=Yt(nt.value);wo(b),mt()}),ki.append(ta,nt),ze.appendChild(ki);const sa=document.createElement("p");sa.className="settings-note",sa.innerHTML='Requires the Obsidian <a href="https://vinzent03.github.io/obsidian-advanced-uri/" target="_blank" rel="noreferrer noopener">Advanced URI</a> plugin for create/open behavior.',ze.appendChild(sa);const ys=b=>`${(b/1e3).toFixed(1)}s`,Si=document.createElement("label");Si.className="settings-slider",Si.setAttribute("for","seriesNavDoubleClickWait");const oa=document.createElement("div");oa.className="settings-slider__text";const ra=document.createElement("span");ra.className="settings-slider__label",ra.textContent="Series double-click wait";const la=document.createElement("span");la.className="settings-slider__hint",la.textContent="Time window to double-click into another map version.",oa.append(ra,la);const Ci=document.createElement("span");Ci.className="settings-slider__value",Ci.textContent=ys(Kn);const Ln=document.createElement("input");Ln.type="range",Ln.id="seriesNavDoubleClickWait",Ln.className="settings-slider__input",Ln.min=String(Va),Ln.max=String($a),Ln.step="50",Ln.value=String(Kn),Ln.setAttribute("aria-label","Adjust double-click wait for series navigation"),Ln.addEventListener("input",()=>{const b=Kt(parseInt(Ln.value,10));Ci.textContent=ys(b),mo(b)}),Si.append(oa,Ci,Ln),ze.appendChild(Si);const ws=b=>`${Math.round((b-1)*100)}%`,Ei=document.createElement("label");Ei.className="settings-slider",Ei.setAttribute("for","hoverScaleSlider");const ca=document.createElement("div");ca.className="settings-slider__text";const da=document.createElement("span");da.className="settings-slider__label",da.textContent="Hover zoom";const pa=document.createElement("span");pa.className="settings-slider__hint",pa.textContent="Expand tiles on hover to see more detail.",ca.append(da,pa);const _i=document.createElement("span");_i.className="settings-slider__value",_i.textContent=ws(Vn);const Nn=document.createElement("input");Nn.type="range",Nn.id="hoverScaleSlider",Nn.className="settings-slider__input",Nn.min=String(h),Nn.max=String(M),Nn.step="0.1",Nn.value=String(Vn),Nn.setAttribute("aria-label","Adjust hover zoom"),Nn.addEventListener("input",()=>{const b=qt(parseFloat(Nn.value));_i.textContent=ws(b),no(b),L&&Zt()}),Ei.append(ca,_i,Nn),ze.appendChild(Ei);const ks=b=>b===1?"Default":`${Math.round(b*100)}%`,Ii=document.createElement("label");Ii.className="settings-slider",Ii.setAttribute("for","tileCompactnessSlider");const ua=document.createElement("div");ua.className="settings-slider__text";const ma=document.createElement("span");ma.className="settings-slider__label",ma.textContent="Tile compactness";const fa=document.createElement("span");fa.className="settings-slider__hint",fa.textContent="Adjust padding, gap, and logo size for tiles.",ua.append(ma,fa);const xi=document.createElement("span");xi.className="settings-slider__value",xi.textContent=ks(kt);const Mn=document.createElement("input");Mn.type="range",Mn.id="tileCompactnessSlider",Mn.className="settings-slider__input",Mn.min=String(Fe),Mn.max=String(wn),Mn.step="0.05",Mn.value=String(kt),Mn.setAttribute("aria-label","Adjust tile compactness"),Mn.addEventListener("input",()=>{const b=Wt(parseFloat(Mn.value));xi.textContent=ks(b),io(b),L&&Zt()}),Ii.append(ua,xi,Mn),ze.appendChild(Ii);const{row:zr}=Tn({id:"titleWrapToggle",label:"Wrap titles",hint:"Allow long titles to wrap instead of truncating.",checked:Oa!=="nowrap",className:"map-controls__toggle",onChange:b=>{const K=b?"wrap":"nowrap";zt(K),co(K)}});ze.appendChild(zr);const Ss=b=>`${Math.round((b-1)*100)}% extra`,Ai=document.createElement("label");Ai.className="settings-slider",Ai.setAttribute("for","titleHoverWidthSlider");const ga=document.createElement("div");ga.className="settings-slider__text";const ha=document.createElement("span");ha.className="settings-slider__label",ha.textContent="Title width on hover";const ba=document.createElement("span");ba.className="settings-slider__hint",ba.textContent="Give titles more room horizontally when zoomed.",ga.append(ha,ba);const Ti=document.createElement("span");Ti.className="settings-slider__value",Ti.textContent=Ss(Ut);const Pn=document.createElement("input");Pn.type="range",Pn.id="titleHoverWidthSlider",Pn.className="settings-slider__input",Pn.min=String(ke),Pn.max=String(He),Pn.step="0.05",Pn.value=String(Ut),Pn.setAttribute("aria-label","Adjust title width boost on hover"),Pn.addEventListener("input",()=>{const b=Gt(parseFloat(Pn.value));Ti.textContent=Ss(b),so(b)}),Ai.append(ga,Ti,Pn),ze.appendChild(Ai);const Cs=b=>`${Math.round(b*100)}% of hover zoom`,Li=document.createElement("label");Li.className="settings-slider",Li.setAttribute("for","titleZoomPortionSlider");const va=document.createElement("div");va.className="settings-slider__text";const ya=document.createElement("span");ya.className="settings-slider__label",ya.textContent="Title zoom influence";const wa=document.createElement("span");wa.className="settings-slider__hint",wa.textContent="How much the title scales relative to tile hover zoom.",va.append(ya,wa);const Ni=document.createElement("span");Ni.className="settings-slider__value",Ni.textContent=Cs(Vt);const Rn=document.createElement("input");Rn.type="range",Rn.id="titleZoomPortionSlider",Rn.className="settings-slider__input",Rn.min=String(mn),Rn.max=String(fn),Rn.step="0.05",Rn.value=String(Vt),Rn.setAttribute("aria-label","Adjust how much titles scale on hover"),Rn.addEventListener("input",()=>{const b=Jt(parseFloat(Rn.value));Ni.textContent=Cs(b),ro(b)}),Li.append(va,Ni,Rn),ze.appendChild(Li);const Kr=typeof _e.isEnabled=="function"?_e.isEnabled():!1,{row:Qr,input:Xr}=Tn({id:"apicurioFeatureToggle",label:"Apicurio",hint:"Show the Apicurio registry tab when enabled.",checked:Kr,className:"apicurio-toggle",onChange:b=>{typeof _e.setEnabled=="function"&&_e.setEnabled(b)}});if(Dt=Xr,ze.appendChild(Qr),Sn.appendChild(ze),f)f.hidden=!1,f.classList.remove("pf-v5-c-page__main-section"),Sn.appendChild(f);else{const b=document.createElement("p");b.className="muted",b.textContent="Source editor unavailable.",Sn.appendChild(b)}x.appendChild(Sn),_e.mount(D);let Es=0;V.m.categories.forEach(b=>{const K=document.createElement("section");K.className="category",K.dataset.cat=b.id;const O=document.createElement("div");O.className="cat-head",O.dataset.cat=b.id,O.tabIndex=0,O.title="Select category",O.innerHTML=`<div class="cat-title">${_t(b.title||b.id)}</div>
                          <div class="muted cat-count">${(b.items||[]).length} items</div>`,O.addEventListener("click",()=>$n(b.id)),O.addEventListener("keydown",Ee=>{(Ee.key==="Enter"||Ee.key===" ")&&(Ee.preventDefault(),$n(b.id))}),O.addEventListener("focus",()=>$n(b.id,{scrollIntoView:!1})),K.appendChild(O);const Ce=document.createElement("div");Ce.className="grid",K.appendChild(Ce),(b.items||[]).forEach(Ee=>{Es+=1;const Bn=ls(Ee.external),Dn=rs(Ee,{externalMeta:Bn,seriesIdLookup:ye}),ft=ja(Ee.id,{excludeIndex:w}),tt=S[w],oi=tt&&(tt.data&&tt.data.id==="network"||Je(tt)==="network"),Ue=document.createElement("div");if(Ue.className=Bn.isExternal?"tile external":"tile",Ue.tabIndex=0,Ue.dataset.id=Ee.id,Ue.dataset.globalIndex=String(Es),Bn.url&&(Ue.dataset.externalUrl=Bn.url),ye.has(Ee.id)){const ri=ye.get(Ee.id);Ue.dataset.seriesVersionIndex=String(ri),Ue.classList.add("tile--series-link");const Yr=ri===Ie?"Current map in this series":`Open version ${ri+1} in this series`;Ue.title=Yr}oi&&ft!==-1&&(Ue.dataset.modelIndex=String(ft),Ue.classList.add("tile--model-link"),Ue.title||(Ue.title="Open map from portfolio")),Dn&&(Ue.dataset.obsidianUrl=Dn);const gt=document.createElement("img");gt.className="logo",Ee.logo?(gt.src=Ee.logo,gt.alt=Ee.name||Ee.id):(gt.alt="",gt.style.opacity=1,gt.src=Zo(Ee.name||Ee.id,Ee.color));const ka=document.createElement("div");ka.className="name",ka.textContent=Ee.name||Ee.id;const Sa=document.createElement("div");Sa.className="tile-id",Sa.textContent=Ee.id||"";const Ca=document.createElement("div");Ca.className="badge",Ca.textContent="reused";const At=document.createElement("button");At.type="button",At.className="tile-delete",At.setAttribute("aria-label",`Delete ${Ee.name||Ee.id}`),At.textContent="×",At.addEventListener("click",ri=>{ri.stopPropagation(),Dr(Ee.id)}),Bn.url&&Ue.appendChild(dr(Bn.url)),cs(Ue,Dn),Ue.appendChild(At),Ue.appendChild(gt),Ue.appendChild(ka),Ue.appendChild(Sa),Ue.appendChild(Ca),Ce.appendChild(Ue),be.set(Ee.id,{el:Ue,catId:b.id,rect:null})}),An.appendChild(K),Ke.set(b.id,{el:K,headEl:O});const Qe=document.createElement("button");Qe.type="button",Qe.className="tile-add",Qe.innerHTML='<span class="tile-add__icon" aria-hidden="true">+</span><span class="tile-add__label"></span>',Qe.addEventListener("click",()=>Er(b.id)),Ce.appendChild(Qe)});const si=document.createElement("button");si.type="button",si.className="category-add",si.innerHTML='<span class="category-add__icon" aria-hidden="true">+</span><span class="category-add__label">Add category</span><span class="category-add__hint">(Insert)</span>',si.addEventListener("click",()=>ms()),An.appendChild(si),ss(),ar(),Ji(),Et(),Ct(),fr()}function ar(){C.querySelectorAll(".tile").forEach(e=>{e.addEventListener("click",t=>{var x;if(typeof t.button=="number"&&t.button!==0)return;kn();const i=e.dataset.id,a=e.dataset.seriesVersionIndex!=null?parseInt(e.dataset.seriesVersionIndex,10):null,s=e.dataset.modelIndex!=null?parseInt(e.dataset.modelIndex,10):ja(i,{excludeIndex:w}),r=e.dataset.globalIndex!=null?parseInt(e.dataset.globalIndex,10):null,d=S[w],p=d?pt(d):-1,g=((x=d==null?void 0:d.apicurioVersions)==null?void 0:x.length)>1&&Number.isInteger(a)&&a!==p,v=Fn&&Fn.id===i&&Fn.targetVersionIndex===a,A=s!==-1&&d&&(d.data&&d.data.id==="network"||Je(d)==="network"),I=Un&&Un.id===i&&Un.targetModelIndex===s;if(Fn&&!v&&Qn(),Un&&!I&&Qn(),g)if(v){if(Qn(),Wi(w,a))return}else Oo(i,a,d);else if(A){if(I){Qn(),Ze(s);return}Uo(i,s,S[s])}else Number.isInteger(r)&&r>0&&r%5===0&&vi("Use arrow keys to move between blocks. Shift arrow to move block.");if(console.log("[Blockscape] click",i),L===i&&!(g&&v)){ni();return}dn(i)}),e.addEventListener("keydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),e.click())});const n=()=>{L&&Zt()};e.addEventListener("pointerenter",n),e.addEventListener("pointerleave",n),e.addEventListener("focus",n),e.addEventListener("blur",n),e.draggable=!0,e.addEventListener("dragstart",vr),e.addEventListener("dragend",yr)}),C.querySelectorAll(".grid").forEach(e=>{e.addEventListener("dragover",wr),e.addEventListener("drop",Cr),e.addEventListener("dragenter",kr),e.addEventListener("dragleave",Sr)}),Qa||(Qa=!0,window.addEventListener("resize",Zt),window.addEventListener("scroll",Zt,{passive:!0}),window.addEventListener("resize",ds)),document.getElementById("clear").onclick=()=>ni()}function Ji(){be.forEach(e=>{e.rect=e.el.getBoundingClientRect()})}function as(e,{includeSecondary:n=pn}={}){if(!e||!V)return{deps:new Set,revs:new Set,secondaryDeps:new Set,secondaryRevs:new Set,edges:[]};const t=new Set(V.fwd.get(e)||[]),i=new Set(V.rev.get(e)||[]),a=new Set,s=new Set,r=[],d=new Set,p=(g,v,A,I)=>{if(!g||!v)return;const x=`${g}->${v}:${A}:${I}`;d.has(x)||(d.add(x),r.push({from:g,to:v,type:A,depth:I}))};return t.forEach(g=>p(e,g,"dep",1)),i.forEach(g=>p(e,g,"revdep",1)),n&&new Set([...t,...i]).forEach(v=>{(V.fwd.get(v)||new Set).forEach(x=>{const D=x===e;D||a.add(x),D||p(v,x,"dep",2)}),(V.rev.get(v)||new Set).forEach(x=>{const D=x===e;D||s.add(x),D||p(v,x,"revdep",2)})}),{deps:t,revs:i,secondaryDeps:a,secondaryRevs:s,edges:r}}function yi(e,n){const t=be.get(e);t&&t.el.classList.add(n)}function dn(e){var d,p,g;if(!e)return;z=null,L=e,he=null,ne=as(e),sn(),Ki(),Ct();const{deps:n,revs:t,secondaryDeps:i,secondaryRevs:a}=ne;console.log("[Blockscape] selecting id=",e,"deps=",Array.from(n),"revs=",Array.from(t));const s=be.get(e);s&&s.el.classList.add("selected"),n.forEach(v=>yi(v,"dep")),t.forEach(v=>yi(v,"revdep")),i.forEach(v=>{!n.has(v)&&v!==e&&yi(v,"dep-indirect")}),a.forEach(v=>{!t.has(v)&&!n.has(v)&&v!==e&&yi(v,"revdep-indirect")}),Et();const r=(g=(p=(d=be.get(e))==null?void 0:d.el)==null?void 0:p.dataset)==null?void 0:g.externalUrl;r&&vi("This item has link to",pi,r)}function $n(e,{scrollIntoView:n=!0,preserveEntryHint:t=!1}={}){var r,d;if(!((r=V==null?void 0:V.m)!=null&&r.categories)||!e)return!1;const a=(V.m.categories||[]).find(p=>p.id===e);if(!a)return!1;kn(),zi(),t||(he=null),z=a.id,sn(),Ct();const s=Ke.get(a.id);return n&&(s!=null&&s.el)&&(s.el.scrollIntoView({behavior:"smooth",block:"center"}),(d=s.headEl)==null||d.focus({preventScroll:!0})),!0}function Ct(){if(Ke.forEach(({el:n,headEl:t})=>{n.classList.remove("category--selected"),t&&t.removeAttribute("aria-current")}),!z)return;const e=Ke.get(z);if(!(e!=null&&e.el)){z=null,he=null,sn();return}e.el.classList.add("category--selected"),e.headEl&&e.headEl.setAttribute("aria-current","true")}function ei(){if(z)return z;const e=L?be.get(L):null;return e!=null&&e.catId?e.catId:null}function sr(e){var s,r,d,p;if(!((r=(s=V==null?void 0:V.m)==null?void 0:s.categories)!=null&&r.length)||!e)return!1;const n=V.m.categories,t=ei();let i=n.findIndex(g=>g.id===t);if(i===-1){const g=((d=n.find(v=>(v.items||[]).length))==null?void 0:d.id)||((p=n[0])==null?void 0:p.id);return g?$n(g):!1}const a=i+e;return a<0||a>=n.length?!1:$n(n[a].id)}function zi(){L=null,ne=null,Ki(),Et()}function or(){z=null,he=null,Ct()}function ni(){zi(),or(),he=null,sn()}function Ki(){C.querySelectorAll(".tile").forEach(e=>e.classList.remove("dep","revdep","dep-indirect","revdep-indirect","selected"))}function ss(){V!=null&&V.reusedLocal&&V.reusedLocal.forEach(e=>{const n=be.get(e);if(!n)return;n.el.classList.toggle("reused",hn);const t=n.el.querySelector(".badge");t&&(t.style.display=hn?"inline-block":"none")})}function Et(){for(;k.firstChild;)k.removeChild(k.firstChild);if(!L||k.hidden)return;ne=as(L),ne.edges.forEach(n=>{var A,I;const t=(A=be.get(n.from))==null?void 0:A.rect,i=(I=be.get(n.to))==null?void 0:I.rect;if(!t||!i)return;const a=os(t),s=os(i),r=document.createElementNS("http://www.w3.org/2000/svg","path"),d=(a.x+s.x)/2,p=a.y,g=(a.x+s.x)/2,v=s.y;r.setAttribute("d",`M ${a.x},${a.y} C ${d},${p} ${g},${v} ${s.x},${s.y}`),r.setAttribute("fill","none"),r.setAttribute("stroke",n.type==="dep"?"var(--blockscape-dep)":"var(--blockscape-revdep)"),r.setAttribute("stroke-opacity",n.depth===1?"0.45":"0.22"),r.setAttribute("stroke-width",n.depth===1?"2":"1.5"),n.depth>1&&r.setAttribute("stroke-dasharray","4 3"),r.setAttribute("vector-effect","non-scaling-stroke"),k.appendChild(r)})}function os(e){return{x:e.left+e.width/2,y:e.top+e.height/2}}function _t(e){return e.replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}function rr(e){const n=(e??"").toString().trim();if(!n)return"";const t=n.endsWith(".md")?n:`${n}.md`,i=new URLSearchParams;return i.set("filepath",t),i.set("data"," "),i.set("mode","append"),Ht&&i.set("vault",Ht),`obsidian://advanced-uri?${i.toString()}`}function lr(e){return e?ui===ln?e.id??e.name??"":e.name??e.id??"":""}function rs(e,{externalMeta:n,seriesIdLookup:t}={}){var a;if(!$t||!e||(a=t==null?void 0:t.has)!=null&&a.call(t,e.id))return"";const i=lr(e);return rr(i)}function ls(e){if(typeof e=="string"){const n=e.trim();if(!n)return{isExternal:!1,url:""};try{const t=new URL(n);return/^https?:/i.test(t.protocol)?{isExternal:!0,url:t.toString()}:{isExternal:!1,url:""}}catch(t){return console.warn("[Blockscape] invalid external url skipped",e,t),{isExternal:!1,url:""}}}return e===!0?{isExternal:!0,url:""}:{isExternal:!1,url:""}}function cr(e){const n=document.createElement("button");return n.type="button",n.className="external-link obsidian-link",n.setAttribute("aria-label","Open in Obsidian"),n.title=e,n.textContent="O",n.addEventListener("click",t=>{t.stopPropagation(),window.open(e,"_blank","noopener")}),n.addEventListener("keydown",t=>t.stopPropagation()),n}function dr(e){const n=document.createElement("button");return n.type="button",n.className="external-link",n.setAttribute("aria-label","Open external reference in a new tab"),n.title=e,n.textContent="↗",n.addEventListener("click",t=>{t.stopPropagation(),window.open(e,"_blank","noopener")}),n.addEventListener("keydown",t=>t.stopPropagation()),n}function cs(e,n){if(!e)return;const t=e.querySelector(".obsidian-link");if(!n){t&&t.remove(),e.removeAttribute("data-obsidian-url");return}if(e.dataset.obsidianUrl=n,t){t.title=n;return}e.appendChild(cr(n))}function ds(){Ot||(Ot=requestAnimationFrame(()=>{Ot=null,zn=zn.filter(({labelEl:e,textEl:n})=>(e==null?void 0:e.isConnected)&&(n==null?void 0:n.isConnected)),zn.forEach(({labelEl:e,textEl:n})=>{const t=Math.max(n.scrollWidth-e.clientWidth,0);if(t>4){const i=Math.max(4,Math.min(14,4+t/30));e.classList.add("version-nav__thumb-label--scroll"),n.style.setProperty("--marquee-distance",`${t}px`),n.style.setProperty("--marquee-duration",`${i}s`)}else e.classList.remove("version-nav__thumb-label--scroll"),n.style.removeProperty("--marquee-distance"),n.style.removeProperty("--marquee-duration")})}))}function pr(e,n){!e||!n||(zn.push({labelEl:e,textEl:n}),ds())}function ur(e,n){var s,r;const t=[`<div class="version-nav__tooltip-title">${_t(n)}</div>`],i=((e==null?void 0:e.version)??((s=e==null?void 0:e.data)==null?void 0:s.version)??"").toString().trim();i&&t.push(`<div class="version-nav__tooltip-meta">Version ${_t(i)}</div>`);const a=(((r=e==null?void 0:e.data)==null?void 0:r.abstract)??"").toString().trim();return a?t.push(`<div class="version-nav__tooltip-body">${a}</div>`):t.push('<div class="version-nav__tooltip-body muted">No info available for this version.</div>'),t.join("")}function ti(e,n,{offset:t=8}={}){!N||!e||!n||(N.innerHTML=n,N.hidden=!1,N.setAttribute("aria-hidden","false"),requestAnimationFrame(()=>{const i=e.getBoundingClientRect(),a=N.getBoundingClientRect(),s=window.scrollX||document.documentElement.scrollLeft,r=window.scrollY||document.documentElement.scrollTop;let d=i.left+i.width/2-a.width/2+s,p=i.top-a.height-t+r;d<s+t&&(d=s+t);const g=s+window.innerWidth-a.width-t;d>g&&(d=g),p<r+t&&(p=i.bottom+t+r),N.style.left=`${d}px`,N.style.top=`${p}px`,N.classList.add("is-visible")}))}function Gn(){yt&&(clearTimeout(yt),yt=null),N&&(N.classList.remove("is-visible"),N.setAttribute("aria-hidden","true"),N.hidden=!0)}function mr(e,n){if(!e)return;const t=Oe((n==null?void 0:n.data)||n,"Series version");e.title=t,e.setAttribute("aria-label",t);const i=ur(n,t);let a=null;const s=()=>{a&&(clearTimeout(a),a=null)},r=()=>{ot=e,ti(e,`<div class="version-nav__tooltip-title">${_t(t)}</div>`,{offset:10})},d=()=>{s(),a=setTimeout(()=>{ot===e&&ti(e,i,{offset:10})},u)},p=()=>{r(),d()},g=()=>{ot!==e&&r(),d()},v=()=>{s(),ot===e&&(ot=null,Gn())};e.addEventListener("mouseenter",p),e.addEventListener("focus",p),e.addEventListener("pointermove",g),e.addEventListener("mouseleave",v),e.addEventListener("blur",v),e.addEventListener("click",v)}function fr(){at&&(at=!1,!(!jn||!wt)&&(Gn(),ti(jn,wt,{offset:12}),yt=setTimeout(()=>{Gn(),gr()},1e3)))}function gr(){jn&&(st&&(clearTimeout(st),st=null),jn.classList.add("blockscape-tab--twinkle"),st=setTimeout(()=>{jn.classList.remove("blockscape-tab--twinkle"),st=null},1400))}window.addEventListener("scroll",Gn,!0),window.addEventListener("resize",Gn);function kn(){m&&(m.classList.remove("is-visible","item-preview--has-frame","item-preview--expanded"),m.setAttribute("aria-hidden","true"),m.hidden=!0,ps([]))}function hr(e,n){m&&(De={x:e,y:n},m.hidden=!1,m.setAttribute("aria-hidden","false"),m.classList.add("is-visible"),It(e,n))}function It(e,n){if(!m)return;const t=12;m.style.left=`${e+t}px`,m.style.top=`${n+t}px`;const i=m.getBoundingClientRect();let a=i.left,s=i.top;i.right>window.innerWidth-t&&(a=Math.max(t,window.innerWidth-i.width-t)),i.bottom>window.innerHeight-t&&(s=Math.max(t,window.innerHeight-i.height-t)),m.style.left=`${a}px`,m.style.top=`${s}px`}function ps(e=[]){me&&(me.innerHTML="",e.forEach(n=>{const t=document.createElement("button");t.type="button",t.className="item-preview__action",t.textContent=n.label||"Action",n.title&&(t.title=n.title),t.addEventListener("click",i=>{i.stopPropagation(),typeof n.onClick=="function"&&n.onClick(i)}),me.appendChild(t)}),me.hidden=e.length===0)}async function br(e,n){var v;if(!m)return;e.stopPropagation(),e.preventDefault();const t=n.dataset.id,i=((v=n.querySelector(".name"))==null?void 0:v.textContent)||t||"Preview",a=t?`${t}.html`:"",s=a?`items/${a}`:"",r=++un,d=n.dataset.externalUrl||"",p=n.dataset.obsidianUrl||"",g=[{label:"Edit",title:"Edit this item",onClick:()=>{kn(),ct.open(t)}}];if(d&&g.push({label:"Open link ↗",title:d,onClick:()=>window.open(d,"_blank","noopener")}),p&&g.push({label:"Open in Obsidian",title:p,onClick:()=>window.open(p,"_blank","noopener")}),ps(g),t&&dn(t),J.textContent=i,de.innerHTML='<div class="item-preview__status">Loading…</div>',m.classList.remove("item-preview--has-frame"),m.classList.add("item-preview--expanded"),hr(e.clientX,e.clientY),!s){de.innerHTML='<div class="item-preview__status">Preview unavailable for this item.</div>',It(De.x,De.y);return}try{const A=await fetch(s,{cache:"no-cache"});if(!A.ok)throw new Error(`HTTP ${A.status}`);const I=await A.text();if(r!==un)return;if(!I.trim()){de.innerHTML=`<div class="item-preview__status">No content in <code>${_t(a)}</code>.</div>`,It(De.x,De.y);return}const D=document.createElement("iframe");D.className="item-preview__frame",D.title=`${i} details`,D.srcdoc=I,de.innerHTML="",de.appendChild(D),m.classList.add("item-preview--has-frame"),It(De.x,De.y)}catch(A){if(r!==un)return;de.innerHTML=`<div class="item-preview__status">No preview available for <strong>${_t(i)}</strong>.</div>`,console.warn(`[Blockscape] preview unavailable for ${s}`,A),It(De.x,De.y)}}Re&&Re.addEventListener("click",kn),pe&&pe.addEventListener("click",()=>{Ho()}),fe&&fe.addEventListener("click",()=>{Fo()}),we&&we.addEventListener("click",Hi),ge&&ge.addEventListener("click",Hi),en&&en.addEventListener("click",Fi),je&&je.addEventListener("click",Fi),C&&C.addEventListener("contextmenu",e=>{const n=e.target.closest(".tile");!n||!C.contains(n)||br(e,n)}),document.addEventListener("click",e=>{typeof e.button=="number"&&e.button!==0||!m||m.hidden||m.contains(e.target)||kn()}),$&&$.addEventListener("click",()=>{za("button")}),Z&&Z.addEventListener("click",()=>{if(w<0){alert("Load or select a model before creating a version.");return}try{const e=Ja({versionLabel:"map edit"});Ze(e),console.log("[Blockscape] created new version from map view")}catch(e){alert((e==null?void 0:e.message)||"Unable to create a new version right now.")}}),W&&W.addEventListener("click",async()=>{var s;if(w<0||!S[w]){alert("Select or load a model before sharing.");return}const e={title:Oe(S[w],"Shared Model"),data:S[w].data};let n;try{n=Js(JSON.stringify(e))}catch(r){console.error("[Blockscape] share encode failed",r),alert("Unable to encode this model for sharing.");return}const t=new URL(window.location.href);t.searchParams.delete("share"),t.hash=`share=${n}`;const i=t.toString();try{window.history.replaceState({},document.title,i)}catch(r){console.warn("[Blockscape] failed to update URL for share",r),window.location.hash=t.hash}let a=!1;if((s=navigator.clipboard)!=null&&s.writeText)try{await navigator.clipboard.writeText(i),a=!0}catch(r){console.warn("[Blockscape] clipboard write failed",r)}a?alert("Share URL copied to clipboard."):window.prompt("Copy this share URL:",i)}),F&&F.addEventListener("click",()=>{const e=(c.value||"").trim();if(!e){alert("Load or paste a model before opening the editor.");return}try{JSON.parse(e)}catch{alert("Current JSON is invalid. Fix it before opening the editor.");return}try{const t={ts:Date.now(),text:e,source:"viewer"};L&&(t.selectedItemId=L),localStorage.setItem(Be,JSON.stringify(t))}catch(t){console.error("[Blockscape] failed to store editor payload",t),alert("Unable to stash JSON for the editor (storage disabled?).");return}let n="editor.html#viewer";L&&(n=`editor.html?selected=${encodeURIComponent(L)}#viewer`),window.open(n,"_blank")}),typeof window<"u"&&(window.addEventListener("storage",e=>{if(!e||e.storageArea&&e.storageArea!==window.localStorage||e.key!==Be||!e.newValue)return;let n;try{n=JSON.parse(e.newValue)}catch(t){console.warn("[Blockscape] storage payload parse failed",t);return}!n||n.source!=="editor"||ns("storage-event")}),window.addEventListener("message",e=>{if(!e||!e.data)return;const n=window.location.origin;if(n&&n!=="null"){if(e.origin!==n)return}else if(e.origin&&e.origin!=="null")return;typeof e.data=="object"&&e.data!==null&&e.data.type===$e&&ns("message")})),document.addEventListener("keydown",e=>{var t,i,a,s,r,d,p,g,v,A;if($o()){e.key==="Escape"&&(e.preventDefault(),Hi());return}if(!(ve!=null&&ve.hidden)&&e.key==="Escape"){e.preventDefault(),Fi();return}if(!((t=ct==null?void 0:ct.isOpen)!=null&&t.call(ct))){if((e.ctrlKey||e.metaKey)&&e.code==="KeyS"){e.preventDefault();const I=S[w],x=((i=I==null?void 0:I.apicurioVersions)==null?void 0:i.length)>1;za("shortcut",x);return}if((e.ctrlKey||e.metaKey)&&!e.altKey&&!e.shiftKey&&e.key&&e.key.toLowerCase()==="z"){if(!dt())return;if(Mr()){e.preventDefault();return}}if(e.key==="Escape"){let I=!1;m&&!m.hidden&&(kn(),I=!0),(L||z)&&(ni(),I=!0),I&&e.preventDefault()}if(e.key==="ArrowLeft"||e.key==="ArrowRight"){if(!dt())return;const I=e.key==="ArrowLeft"?-1:1;if(e.altKey)return;if((e.ctrlKey||e.metaKey)&&!e.shiftKey){Gi(I)&&e.preventDefault();return}if(e.ctrlKey||e.metaKey)return;if(z&&!e.shiftKey){e.preventDefault();return}e.shiftKey?Ir(I)&&e.preventDefault():xr(I)&&e.preventDefault()}if(e.key==="ArrowUp"||e.key==="ArrowDown"){if(!dt())return;const I=e.key==="ArrowUp"?-1:1;if((e.ctrlKey||e.metaKey)&&!e.altKey){Nr(I)&&e.preventDefault();return}if(e.altKey)return;if(z&&!L&&!e.shiftKey){if(Tr(I)){e.preventDefault();return}if(sr(I)){e.preventDefault();return}}e.shiftKey?Lr(I)&&e.preventDefault():Ar(I)&&e.preventDefault()}if(e.key==="Delete"){if(!dt()||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return;const I=z?Br():!1,x=I?!0:fs();(I||x)&&e.preventDefault()}if(e.key==="F2"){if(!dt())return;const I=z&&!L&&z||!L&&((d=(r=(s=(a=e.target)==null?void 0:a.closest)==null?void 0:s.call(a,".category"))==null?void 0:r.dataset)==null?void 0:d.cat)||null;if(I&&!L&&_r(I)){e.preventDefault();return}const x=L||((A=(v=(g=(p=e.target)==null?void 0:p.closest)==null?void 0:g.call(p,".tile"))==null?void 0:v.dataset)==null?void 0:A.id);x&&ct.open(x)&&e.preventDefault()}if(e.key==="Insert"){if(!dt()||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return;ms()&&e.preventDefault()}}}),window.addEventListener("resize",()=>{!m||m.hidden||It(De.x,De.y)}),window.addEventListener("scroll",()=>{!m||m.hidden||kn()},!0);let Zn=null,ii=null;function vr(e){kn(),Zn=e.target.dataset.id,ii=e.target.closest(".category").dataset.cat,e.target.classList.add("dragging"),e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",JSON.stringify({itemId:Zn,categoryId:ii})),e.target.closest(".category").querySelector(".grid").classList.add("drag-active"),console.log("[Blockscape] drag start",Zn,"from",ii)}function yr(e){e.target.classList.remove("dragging"),C.querySelectorAll(".grid").forEach(n=>n.classList.remove("drag-active")),C.querySelectorAll(".tile").forEach(n=>n.classList.remove("drag-over")),Zn=null,ii=null}function wr(e){e.preventDefault(),e.dataTransfer.dropEffect="move"}function kr(e){e.preventDefault();const n=e.target.closest(".grid");n&&n.classList.add("drag-active")}function Sr(e){const n=e.target.closest(".grid");n&&!n.contains(e.relatedTarget)&&n.classList.remove("drag-active")}function Cr(e){e.preventDefault();const n=e.target.closest(".grid");if(!n)return;const t=n.closest(".category");if(!t)return;const i=t.dataset.cat;if(!Zn||!i)return;const s=Array.from(n.querySelectorAll(".tile")).filter(r=>r.dataset.id!==Zn).find(r=>{const d=r.getBoundingClientRect();return e.clientY<d.top+d.height/2});us(Zn,s?s.dataset.id:null,i),St(),console.log("[Blockscape] drop completed",Zn,"from",ii,"to",i)}function us(e,n,t){if(w<0)return;const a=S[w].data.categories||[],s=a.find(v=>(v.items||[]).some(A=>A.id===e)),r=a.find(v=>v.id===t);if(!s||!r)return;s.items=s.items||[],r.items=r.items||[];const d=s.items.findIndex(v=>v.id===e);if(d===-1)return;const[p]=s.items.splice(d,1);let g=r.items.length;if(n){const v=r.items.findIndex(A=>A.id===n);v!==-1&&(g=v)}r.items.splice(g,0,p),cn(),rn()}function Er(e){if(w<0||!e)return;const n=S[w].data,i=(n.categories||[]).find(p=>p.id===e);if(!i)return;i.items=i.items||[];const a=`New item ${i.items.length+1}`,r={id:Ao(`${e}-${i.items.length+1}`,n),name:a,deps:[]};i.items.push(r),cn(),rn(),kn(),dn(r.id);const d=be.get(r.id);d!=null&&d.el&&d.el.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),console.log("[Blockscape] added item",r.id,"to",e)}function ms(){if(w<0)return!1;const e=S[w].data;e.categories=e.categories||[];const n=`New category ${e.categories.length+1}`,t=To(n,e),i={id:t,title:n,items:[]};return e.categories.push(i),z=t,L=null,ne=null,he=null,cn(),rn(),$n(t),console.log("[Blockscape] added category",t),!0}function _r(e=ei()){if(w<0||!e)return!1;const n=No.open(e);return n&&(L=null,ne=null,sn()),n}function Ir(e){if(!L||w<0||!e)return!1;const t=S[w].data.categories||[],i=be.get(L);let a=null;if(i!=null&&i.catId&&(a=t.find(p=>p.id===i.catId)),a||(a=t.find(p=>(p.items||[]).some(g=>g.id===L))),!a)return!1;a.items=a.items||[];const s=a.items.findIndex(p=>p.id===L);if(s===-1)return!1;const r=s+e;if(r<0||r>=a.items.length)return!1;const[d]=a.items.splice(s,1);return a.items.splice(r,0,d),cn(),rn(),St(),dn(L),!0}function xr(e){if(!V||!V.m||!e)return!1;const n=V.m.categories||[];if(!n.length)return!1;const t=()=>{const p=n.find(g=>(g.items||[]).length);return p?{category:p,item:p.items[0]}:null};if(!L){const p=t();return p?(dn(p.item.id),!0):!1}const i=be.get(L);let a=null;if(i!=null&&i.catId&&(a=n.find(p=>p.id===i.catId)),a||(a=n.find(p=>(p.items||[]).some(g=>g.id===L))),!a){const p=t();return p?(dn(p.item.id),!0):!1}const s=a.items||[];if(!s.length)return!1;const r=s.findIndex(p=>p.id===L);if(r===-1)return!1;const d=r+e;return d<0||d>=s.length?!1:(dn(s[d].id),!0)}function Ar(e){if(!V||!V.m||!e)return!1;const n=V.m.categories||[];if(!n.length)return!1;const t=ei();let i=n.findIndex(r=>r.id===t),a=i+e;if(i===-1&&(a=e>0?0:n.length-1),a<0||a>=n.length)return!1;const s=n[a];if(L){const d=(n[i].items||[]).findIndex(p=>p.id===L);he={catId:s.id,position:d===-1?0:d}}else he=null;return $n(s.id,{preserveEntryHint:!0})}function Tr(e){var s;if(!z||!((s=V==null?void 0:V.m)!=null&&s.categories)||!e)return!1;const t=(V.m.categories||[]).find(r=>r.id===z);if(!t)return!1;const i=t.items||[];if(!i.length)return!1;let a=e>0?0:Math.max(0,i.length-1);return(he==null?void 0:he.catId)===t.id&&(a=Math.min(i.length-1,Math.max(0,he.position||0))),he=null,dn(i[a].id),!0}function Lr(e){if(!L||w<0||!e)return!1;const t=S[w].data.categories||[];if(!t.length)return!1;const i=be.get(L);let a=-1;if(i!=null&&i.catId&&(a=t.findIndex(A=>A.id===i.catId)),a===-1&&(a=t.findIndex(A=>(A.items||[]).some(I=>I.id===L))),a===-1)return!1;const s=a+e;if(s<0||s>=t.length)return!1;const r=t[a],d=t[s];if(!d)return!1;r.items=r.items||[],d.items=d.items||[];const p=r.items.findIndex(A=>A.id===L);if(p===-1)return!1;const g=Math.min(d.items.length,Math.max(0,p)),v=g<d.items.length?d.items[g].id:null;return us(L,v,d.id),St(),dn(L),!0}function Nr(e){if(w<0||!e)return!1;const t=S[w].data.categories||[];if(!t.length)return!1;const i=ei();if(!i)return!1;const a=t.findIndex(d=>d.id===i);if(a===-1)return!1;const s=a+e;if(s<0||s>=t.length)return!1;const[r]=t.splice(a,1);return t.splice(s,0,r),z=r.id,zi(),he=null,sn(),cn(),rn(),Ct(),console.log("[Blockscape] moved category",r.id,"from",a,"to",s),!0}function Mr(){if(w<0)return!1;const e=S[w],n=Je(e)||(e?e.id:null),t=[];if(Ye&&n===Ye.modelId&&t.push({...Ye,type:"item"}),ie&&n===ie.modelId&&t.push({...ie,type:"category"}),!t.length)return!1;const i=t.reduce((a,s)=>a?(s.ts||0)>(a.ts||0)?s:a:s,null);if(!i)return!1;if(i.type==="category"){if(Rr(i))return!0}else if(i.type==="item"&&Pr(i))return!0;return!1}function Pr(e){const n=S[w],t=Je(n)||(n?n.id:null);if(!n||t!==e.modelId)return!1;const s=(n.data.categories||[]).find(d=>d.id===e.categoryId);if(!s)return!1;s.items=s.items||[];const r=Math.min(Math.max(e.index,0),s.items.length);return s.items.splice(r,0,e.item),Ye=null,kn(),L=null,ne=null,sn(),cn(),rn(),St(),dn(e.item.id),console.log("[Blockscape] undo delete restored",e.item.id),!0}function Rr(e){const n=S[w],t=Je(n)||(n?n.id:null);if(!n||t!==e.modelId)return!1;const i=n.data;i.categories=i.categories||[];const a=Math.min(Math.max(e.index,0),i.categories.length);return i.categories.splice(a,0,e.category),ie=null,L=null,ne=null,z=e.category.id,he=null,sn(),cn(),rn(),Ct(),$n(e.category.id),console.log("[Blockscape] undo delete restored category",e.category.id),!0}function fs(){if(!L||w<0)return!1;const n=S[w].data.categories||[];if(!n.length)return!1;const t=be.get(L);let i=null;if(t!=null&&t.catId&&(i=n.find(g=>g.id===t.catId)),i||(i=n.find(g=>(g.items||[]).some(v=>v.id===L))),!i||!Array.isArray(i.items))return!1;const a=i.items.findIndex(g=>g.id===L);if(a===-1)return!1;const s=i.items.splice(a,1)[0];if(!s)return!1;const r=S[w];Ye={item:s,categoryId:i.id,index:a,modelId:Je(r)||(r?r.id:null),ts:Date.now()};const p=(()=>{var v;if(i.items.length){const A=Math.min(a,i.items.length-1);return((v=i.items[A])==null?void 0:v.id)||null}const g=n.findIndex(A=>A.id===i.id);if(g===-1)return null;for(let A=g+1;A<n.length;A++){const I=n[A].items||[];if(I.length)return I[0].id}for(let A=g-1;A>=0;A--){const I=n[A].items||[];if(I.length)return I[0].id}return null})();return kn(),L=null,ne=null,he=null,sn(),cn(),rn(),St(),p?dn(p):ni(),console.log("[Blockscape] removed item",s.id),!0}function Br(){var d,p;const e=ei();if(!e||w<0)return!1;const t=S[w].data.categories||[];if(!t.length)return!1;const i=t.findIndex(g=>g.id===e);if(i===-1)return!1;const[a]=t.splice(i,1);if(!a)return!1;const s=S[w];ie={category:a,index:i,modelId:Je(s)||(s?s.id:null),ts:Date.now()},z=null,L=null,ne=null,he=null,sn(),cn(),rn();const r=((d=t[i])==null?void 0:d.id)||((p=t[i-1])==null?void 0:p.id)||null;return r?$n(r):ni(),console.log("[Blockscape] removed category",a.id),!0}function Dr(e){if(!e)return!1;const n=L;L=e;const t=fs();return t||(L=n,sn()),t}Ve&&(wi(),Ve.addEventListener("click",async e=>{const n=e.target.closest("button[data-set-id]");if(!n)return;const t=n.dataset.setId||ht;if(t!==Ge){if(S.length){const i=S.length===1?"":"s";if(!window.confirm(`Switching portfolio will discard the ${S.length} current model${i}. Continue?`))return}try{await $r(t)}catch(i){console.error("[Blockscape] directory load error:",i),alert("Failed to load that set (see console).")}}})),X&&X.addEventListener("click",async()=>{const e=c.value||"";if(!e.trim()){alert("JSON editor is empty.");return}await Ha(e)?alert("JSON copied to clipboard."):window.prompt("Copy this JSON manually:",e)}),Se&&Se.addEventListener("click",async()=>{const e=Mo();if(!e){alert("No series available to copy. Create another version first.");return}await Ha(e)?alert("Series JSON copied to clipboard."):window.prompt("Copy this series JSON manually:",e)}),P&&P.addEventListener("click",async()=>{try{const e=await Qs();if(!e){alert("Clipboard is empty.");return}c.value=e,c.focus()}catch(e){console.warn("[Blockscape] clipboard read failed",e),alert("Unable to read from the clipboard. Use Cmd/Ctrl+V inside the editor instead.")}}),document.getElementById("appendFromBox").onclick=()=>{try{const e=Yn(c.value,"Pasted",{promptForSeriesName:!0});if(!e.length){alert("No valid JSON found to append.");return}console.log("[Blockscape] appending",e.length,"model(s)");let n=null;e.forEach((t,i)=>{const a=Wn(t,{versionLabel:e.length>1?`paste #${i+1}`:"paste"});n==null&&(n=a)}),w===-1&&n!=null?Ze(n):Xn()}catch(e){console.error("[Blockscape] append error:",e),alert("Append error (see console).")}},document.getElementById("replaceActive").onclick=()=>{var e;if(w<0){alert("No active model selected.");return}try{const n=JSON.parse(c.value);if(lt(n,{titleHint:Oe(S[w]),idHint:Je(S[w])||Oe(S[w])}),S[w].data=n,S[w].title=n.title||S[w].title,S[w].isSeries||((e=S[w].apicurioVersions)==null?void 0:e.length)>1){const t=S[w].title||Oe(S[w]);gn(S[w],{seriesName:t,fallbackTitle:t})}bi(),console.log("[Blockscape] replaced active model:",Oe(S[w])),rn(),_e.updateAvailability()}catch(n){console.error("[Blockscape] replace error:",n),alert("JSON parse error (see console).")}},document.getElementById("file").onchange=async e=>{const n=Array.from(e.target.files||[]);if(n.length)try{console.log("[Blockscape] reading",n.length,"file(s)");let t=null;for(const i of n){const a=await i.text(),s=i.name.replace(/\.[^.]+$/,"")||"File",r=Yn(a,s,{seriesTitleOverride:`${s} series`});if(!r.length){console.warn("[Blockscape] no models in file:",i.name);continue}r.forEach((d,p)=>{var ce;const g=(((ce=d.data)==null?void 0:ce.title)??"").toString().trim(),v=r.length>1?`${i.name} #${p+1}`:i.name,A=`${s} series`,I=d.isSeries?A:null;let x={...d};if(d.isSeries){const ye=I||g||d.title||v||"unknown";x.title=ye;const Ie=vt(ye||"unknown");mi(x,Ie),gn(x,{seriesName:ye,fallbackTitle:"unknown"}),x.apicurioArtifactName=x.apicurioArtifactName||ye}else x.title=g||v;const D=Wn({...x,apicurioArtifactName:x.apicurioArtifactName||I||x.apicurioArtifactName},{versionLabel:i.name});t==null&&(t=D)})}w===-1&&t!=null?Ze(t):Xn()}catch(t){console.error("[Blockscape] file load error:",t),alert("File load error (see console).")}finally{e.target.value=""}},document.addEventListener("paste",Or);function Or(e){var a;if(!dt())return;const n=((a=e.clipboardData)==null?void 0:a.getData("text/plain"))||window.clipboardData&&window.clipboardData.getData("Text")||"";if(!Ko(n))return;let t=[];try{t=Yn(n,"Clipboard",{promptForSeriesName:!0})}catch(s){console.warn("[Blockscape] clipboard paste ignored (invalid JSON)",s);return}if(!t.length)return;e.preventDefault();let i=null;t.forEach((s,r)=>{const d=Wn(s,{versionLabel:t.length>1?`paste #${r+1}`:"paste"});i==null&&(i=d)}),console.log(`[Blockscape] pasted ${t.length} model(s) from clipboard`),i!=null&&Ze(i)}j.addEventListener("click",e=>{const n=e.target.closest("button[data-index]");if(!n)return;const t=parseInt(n.dataset.index,10);Number.isInteger(t)&&(Bo(),Ze(t))}),document.getElementById("removeModel").onclick=()=>{if(w<0)return;const e=Oe(S[w]);if(!window.confirm(`Remove "${e}" from this session?`))return;if(console.log("[Blockscape] removing model:",Oe(S[w])),S.splice(w,1),!S.length){w=-1,V=null,C.innerHTML="",k.innerHTML="",c.value="",Xn(),bi();return}const t=Math.min(w,S.length-1);Ze(t)},R&&(R.addEventListener("input",e=>{qi(e.target.value||"")}),R.addEventListener("focus",()=>{R.value&&R.value.trim()&&Ya(R.value)})),Q&&Q.addEventListener("click",e=>{const n=e.target.closest(".search-result");if(!n)return;const t=parseInt(n.dataset.modelIndex||"-1",10),i=n.dataset.itemId;Wo({modelIndex:t,itemId:i})}),document.addEventListener("click",e=>{if(!Q||Q.hidden)return;const n=e.target;Q.contains(n)||R&&(n===R||R.contains(n))||(Q.hidden=!0)}),G&&q&&re&&G.addEventListener("submit",async e=>{e.preventDefault();const n=q.value.trim();if(!n){alert("Please enter a URL"),q.focus();return}const t=await Xi(n);if(typeof t=="number"){Ze(t),q.value="";const i=document.getElementById("urlHint");i&&(i.textContent="")}}),function(){const n=document.getElementById("urlHint");if(!q||!n)return;let t=null;q.addEventListener("input",()=>{clearTimeout(t),t=setTimeout(()=>{const a=q.value.slice(-12);n.textContent=a?`…${a}`:""},300)})}();function rn(){if(!(w<0))try{V=Yo(S[w].data),St()}catch(e){console.error("[Blockscape] rebuild error (active model likely malformed):",e),alert("Active model parse/render error (see console).")}}function Ur(){S.length=0,w=-1,Ge=ht,V=null,be=new Map,Ke=new Map,L=null,z=null,ne=null,he=null,Ye=null,ie=null,Fn=null,Un=null,bn&&(clearTimeout(bn),bn=null),vn&&(clearTimeout(vn),vn=null),zn=[],C&&(C.innerHTML=""),k&&(k.innerHTML=""),c&&(c.value=""),R&&(R.value="",qi("")),Q&&(Q.innerHTML="",Q.hidden=!0),sn(),bi()}async function Vr(e){const n=zl(e);if(n!=null)return n;const t=await fetch(Jl(e),{cache:"no-store"});if(!t.ok)throw new Error(`[Blockscape] ${e} not fetched (${t.status})`);return t.text()}async function Qi(e=Ri,{replaceExisting:n=!1,includeSeed:t=!1,setActiveAfterLoad:i=!1,collectionLabel:a}={}){const s=Array.isArray(e)?[...e]:[];n&&Ur();let r=null;t&&o&&Yn(o,"Blockscape").forEach(p=>{const g=Wn(p,{versionLabel:"seed"});r==null&&(r=g)});for(const d of s){const p=Di(d);if(p)try{const g=await Vr(p),A=(p.split("/").pop()||p).replace(/\.[^.]+$/,"")||"Model",I=Yn(g,A,{seriesTitleOverride:`${A} series`});if(!I.length){console.warn("[Blockscape] no models found in",p);continue}I.forEach(x=>{let D={...x};if(x.isSeries){const ye=`${A} series`;D={...x,title:ye,apicurioArtifactName:ye};const Ie=vt(ye||"unknown");mi(D,Ie),gn(D,{seriesName:ye,fallbackTitle:"unknown"})}const ce=Wn(D,{versionLabel:a||p});r==null&&(r=ce)}),console.log(`[Blockscape] loaded ${I.length} model(s) from ${a||p}`)}catch(g){console.log("[Blockscape] could not load",p,"- this is normal for file:// protocol",g)}}return i?r!=null?Ze(r):S.length?Ze(0):Xn():Xn(),_e.updateAvailability(),r}function wi(){if(!Ve)return;Ve.innerHTML="",[{id:ht,title:"Default maps",count:Ri.length},...Array.from(We.entries()).sort((n,t)=>n[0].localeCompare(t[0])).map(([n,t])=>({id:n,title:n,count:t.length}))].forEach(n=>{const t=document.createElement("li");t.className="model-nav-item";const i=document.createElement("button");i.type="button",i.className="model-nav-button"+(n.id===Ge?" is-active":""),i.dataset.setId=n.id,i.setAttribute("aria-current",n.id===Ge?"true":"false");const a=document.createElement("span");a.className="model-nav-label";const s=document.createElement("span");s.className="model-nav-title",s.textContent=n.title,a.appendChild(s);const r=document.createElement("span");r.className="model-nav-meta",r.textContent=`${n.count} file${n.count===1?"":"s"}`,i.appendChild(a),i.appendChild(r),t.appendChild(i),Ve.appendChild(t)})}async function $r(e){if(e===ht){await Qi(Ri,{replaceExisting:!0,includeSeed:!0,setActiveAfterLoad:!0,collectionLabel:"default"}),Ge=ht,wi();return}const n=We.get(e)||[];if(!n.length){alert(`No .bs files found in ${e}.`);return}await Qi(n.map(t=>t.relativePath),{replaceExisting:!0,includeSeed:!1,setActiveAfterLoad:!0,collectionLabel:e}),Ge=e,wi()}async function Hr(e){const n=[{cache:"no-store"},{cache:"reload"},{}];let t=null;for(const i of n)try{console.log(`[Blockscape] fetching ${e} with cache="${i.cache??"default"}"`);const a=await fetch(e,i);if(a.status===304){console.warn("[Blockscape] fetch returned 304 (Not Modified), retrying without cache");continue}if(!a.ok)throw new Error(`HTTP ${a.status}: ${a.statusText}`);return await a.text()}catch(a){t=a}throw t||new Error("Unable to fetch URL")}function Fr(e){if(!e)return;const n=document.createTreeWalker(e,NodeFilter.SHOW_TEXT),t=[];for(;n.nextNode();)t.push(n.currentNode);t.forEach(i=>jr(i)),e.querySelectorAll("a[href]").forEach(i=>{const a=i.getAttribute("href");hs(a)&&gs(i,a)})}function jr(e){var d,p;if(!e||!e.nodeValue||!e.nodeValue.includes("http")||(p=(d=e.parentNode)==null?void 0:d.closest)!=null&&p.call(d,"a"))return;const n=e.nodeValue,t=/(https?:\/\/[^\s<]+)/gi,i=[];let a;for(;(a=t.exec(n))!==null;)i.push({url:a[0],index:a.index});if(!i.length)return;const s=document.createDocumentFragment();let r=0;i.forEach(({url:g,index:v})=>{v>r&&s.appendChild(document.createTextNode(n.slice(r,v))),s.appendChild(qr(g)),r=v+g.length}),r<n.length&&s.appendChild(document.createTextNode(n.slice(r))),e.parentNode.replaceChild(s,e)}function qr(e){const n=document.createElement("a");return n.href=e,n.textContent=e,n.target="_blank",n.rel="noopener noreferrer",hs(e)&&gs(n,e),n}function gs(e,n){!e||e.dataset.gistLinkBound==="true"||(e.dataset.gistLinkBound="true",e.classList.add("blockscape-gist-link"),e.title="Load this Gist into Blockscape",e.addEventListener("click",t=>Wr(t,n,e)))}async function Wr(e,n,t){if(e.preventDefault(),e.stopPropagation(),!(!n||t.dataset.loading==="true")){t.dataset.loading="true",t.classList.add("is-loading");try{await Xi(n)}finally{t.dataset.loading="false",t.classList.remove("is-loading")}}}function hs(e){if(typeof e!="string")return!1;try{const t=new URL(e,window.location.href).hostname.toLowerCase();return t==="gist.githubusercontent.com"||t.startsWith("gist.")&&t.endsWith("githubusercontent.com")}catch{return!1}}async function Xi(e){try{console.log("[Blockscape] loading from URL:",e);const n=await Hr(e),i=(e.split("/").pop()||"").replace(/\.[^.]+$/,"")||"URL Model";let a;try{a=Yn(n,i)}catch(r){throw new Error(`Invalid JSON payload: ${r.message}`)}if(!a.length)throw new Error("No JSON objects found in response.");let s=null;return a.forEach((r,d)=>{var x;const p=(((x=r.data)==null?void 0:x.title)??"").toString().trim(),g=a.length>1?`${i} #${d+1}`:i,v=r.isSeries?`${i} series`:null;let A={...r};if(r.isSeries){const D=v||p||A.title||g;A={...r,title:D,apicurioArtifactName:D||r.apicurioArtifactName};const ce=vt(D||"unknown");mi(A,ce),gn(A,{seriesName:D||v||"unknown",fallbackTitle:"unknown"}),console.log("[Blockscape] loadFromUrl: series slug applied",{seriesSlug:ce,url:e,baseName:i,seriesTitle:D})}const I=Wn({...A,title:p||A.title||g,apicurioArtifactName:A.apicurioArtifactName||v||r.apicurioArtifactName},{versionLabel:i});s==null&&(s=I)}),console.log(`[Blockscape] loaded ${a.length} model(s) from URL:`,i),w===-1&&s!=null?Ze(s):Xn(),s}catch(n){return console.error("[Blockscape] URL load error:",n),alert(`Failed to load JSON from URL: ${n.message}`),null}}(async function(){if(!o)throw new Error("Seed template is empty.");const n=Yn(o,"Blockscape");if(!n.length)throw new Error("Seed template could not be parsed.");let t=null;n.forEach(p=>{const g=Wn(p,{versionLabel:"seed"});t==null&&(t=g)}),await Qi(Ri),Ge=ht,wi();const i=await Xo(),a=es(),s=a==null?void 0:a.index,r=Qo();Ze(typeof i=="number"?i:typeof r=="number"?r:typeof s=="number"?s:t??0)})()}function Xl(o){let c;return{c(){c=U("div"),c.innerHTML='<div id="shortcutHelpBackdrop" class="shortcut-help__backdrop"></div> <div class="shortcut-help__panel" tabindex="-1"><div class="shortcut-help__header"><div class="shortcut-help__title"><h2 id="shortcutHelpTitle">Help</h2></div> <button id="shortcutHelpClose" class="shortcut-help__close" type="button" aria-label="Close keyboard shortcuts">×</button></div> <section class="shortcut-help__section"><ul class="shortcut-help__tips"><li>Play around with the example maps.</li> <li>Read about <a href="https://www.wardleymaps.com" target="_blank" rel="noreferrer noopener">Wardley Maps</a>.</li> <li>Copy this URL and use &quot;Load URL&quot;: <a href="https://gist.githubusercontent.com/pwright/86dbb074b35d6d17671bf17ecbf1a824/raw/git.bs" target="_blank" rel="noreferrer noopener">https://gist.githubusercontent.com/pwright/86dbb074b35d6d17671bf17ecbf1a824/raw/git.bs</a></li> <li>Edit maps by moving items with Shift + Arrow keys.</li></ul></section> <section class="shortcut-help__section"><h3 class="shortcut-help__section-title">Keyboard shortcuts</h3> <div id="shortcutHelpList" class="shortcut-help__list" aria-live="polite"></div></section></div>',y(c,"id","shortcutHelp"),y(c,"class","shortcut-help"),c.hidden=!0,y(c,"aria-hidden","true"),y(c,"role","dialog"),y(c,"aria-modal","true"),y(c,"aria-labelledby","shortcutHelpTitle")},m(f,C){on(f,c,C)},p:Jn,i:Jn,o:Jn,d(f){f&&Xe(c)}}}class Yl extends Da{constructor(c){super(),Ba(this,c,null,Xl,Pa,{})}}const Zl=`Generate a blockscape [map|series] for the domain of [DOMAIN]
...
\`\`\``;function Ds(o){let c,f,C,k,N,j,m,G;return{c(){c=U("div"),f=U("div"),C=U("a"),k=Ra("Open Blockscape GPT"),N=oe(),j=U("div"),j.textContent="Paste the copied prompt into that chat.",m=oe(),G=U("div"),G.innerHTML='<span>Gem is not available yet</span> <div class="new-panel__hint">https://gemini.google.com/gems/create</div>',y(C,"href",nc),y(C,"target","_blank"),y(C,"rel","noreferrer"),y(j,"class","new-panel__hint"),y(f,"class","new-panel__link"),y(G,"class","new-panel__link new-panel__link--disabled"),y(c,"class","new-panel__links")},m(q,re){on(q,c,re),T(c,f),T(f,C),T(C,k),T(f,N),T(f,j),T(c,m),T(c,G)},p:Jn,d(q){q&&Xe(c)}}}function Os(o){let c,f,C,k,N,j;return{c(){c=U("div"),f=U("div"),f.textContent="Generated prompt",C=oe(),k=U("textarea"),y(f,"class","new-panel__prompt-label"),y(k,"class","pf-v5-c-form-control new-panel__textarea"),y(k,"rows","4"),k.readOnly=!0,y(c,"class","new-panel__prompt")},m(m,G){on(m,c,G),T(c,f),T(c,C),T(c,k),Pt(k,o[4]),N||(j=bt(k,"input",o[12]),N=!0)},p(m,G){G&16&&Pt(k,m[4])},d(m){m&&Xe(c),N=!1,j()}}}function ec(o){let c,f,C,k,N,j,m,G,q,re,J,de,me,Re,$,W,Z,F,X,Se,P,pe,fe,te,le,we,ge,ve,en,je,R,Q,Ve,Be,$e,qe,Ae,We,S,w,Ge,_e,V,be,Ke,L=o[2]==="gpt"&&Ds(),z=o[4]&&o[5]&&Os(o);return V=al(o[10][0]),{c(){c=U("div"),f=U("div"),C=oe(),k=U("div"),N=U("div"),N.innerHTML='<div class="shortcut-help__title"><h2 id="newPanelTitle">New blockscape</h2> <p class="shortcut-help__subtitle">Describe what you need and we will create a prompt for you.</p></div> <button id="newPanelClose" class="shortcut-help__close" type="button" aria-label="Close new panel">×</button>',j=oe(),m=U("form"),G=U("div"),q=U("label"),q.textContent="Domain",re=oe(),J=U("p"),J.textContent="Describe what you want to create a map for.",de=oe(),me=U("textarea"),Re=oe(),$=U("div"),W=U("label"),Z=U("input"),F=oe(),X=U("span"),X.innerHTML=`Series
            <span class="new-panel__hint">Toggle on to create a series instead of a single map.</span>`,Se=oe(),P=U("fieldset"),pe=U("legend"),pe.textContent="Target",fe=oe(),te=U("p"),te.textContent="Choose where you plan to use the prompt.",le=oe(),we=U("label"),ge=U("input"),ve=oe(),en=U("div"),en.innerHTML='<div class="new-panel__option-title">GPT or Gem</div> <div class="new-panel__hint">Copies a simple prompt tailored for GPT or Gem.</div>',je=oe(),R=U("label"),Q=U("input"),Ve=oe(),Be=U("div"),Be.innerHTML='<div class="new-panel__option-title">Plain LLM</div> <div class="new-panel__hint">Creates a large prompt to generate blockscape from scratch.</div>',$e=oe(),qe=U("div"),Ae=U("button"),Ae.textContent="Copy prompt",We=oe(),S=U("div"),w=Ra(o[3]),Ge=oe(),L&&L.c(),_e=oe(),z&&z.c(),y(f,"id","newPanelBackdrop"),y(f,"class","shortcut-help__backdrop"),y(N,"class","shortcut-help__header"),y(q,"for","newDomain"),y(J,"class","new-panel__hint"),y(me,"id","newDomain"),y(me,"class","pf-v5-c-form-control new-panel__textarea"),y(me,"rows","4"),me.required=!0,y(me,"placeholder","Ex: Companies building open-source geospatial tools"),y(G,"class","new-panel__field"),y(Z,"id","seriesToggle"),y(Z,"type","checkbox"),y(W,"class","new-panel__toggle"),y(W,"for","seriesToggle"),y($,"class","new-panel__field"),y(te,"class","new-panel__hint"),y(ge,"type","radio"),y(ge,"name","target"),ge.__value="gpt",Pt(ge,ge.__value),y(we,"class","new-panel__option"),y(Q,"type","radio"),y(Q,"name","target"),Q.__value="plain",Pt(Q,Q.__value),y(R,"class","new-panel__option"),y(P,"class","new-panel__field"),y(Ae,"class","pf-v5-c-button pf-m-primary"),y(Ae,"type","submit"),y(S,"class","new-panel__status"),y(S,"aria-live","polite"),y(qe,"class","new-panel__actions"),y(m,"class","shortcut-help__list new-panel__form"),y(k,"class","shortcut-help__panel"),y(k,"tabindex","-1"),y(c,"id","newPanel"),y(c,"class","shortcut-help"),c.hidden=!0,y(c,"aria-hidden","true"),y(c,"role","dialog"),y(c,"aria-modal","true"),y(c,"aria-labelledby","newPanelTitle"),V.p(ge,Q)},m(ne,he){on(ne,c,he),T(c,f),T(c,C),T(c,k),T(k,N),T(k,j),T(k,m),T(m,G),T(G,q),T(G,re),T(G,J),T(G,de),T(G,me),Pt(me,o[0]),T(m,Re),T(m,$),T($,W),T(W,Z),Z.checked=o[1],T(W,F),T(W,X),T(m,Se),T(m,P),T(P,pe),T(P,fe),T(P,te),T(P,le),T(P,we),T(we,ge),ge.checked=ge.__value===o[2],T(we,ve),T(we,en),T(P,je),T(P,R),T(R,Q),Q.checked=Q.__value===o[2],T(R,Ve),T(R,Be),T(m,$e),T(m,qe),T(qe,Ae),T(qe,We),T(qe,S),T(S,w),T(m,Ge),L&&L.m(m,null),T(m,_e),z&&z.m(m,null),be||(Ke=[bt(me,"input",o[7]),bt(Z,"change",o[8]),bt(ge,"change",o[9]),bt(Q,"change",o[11]),bt(m,"submit",il(o[6]))],be=!0)},p(ne,[he]){he&1&&Pt(me,ne[0]),he&2&&(Z.checked=ne[1]),he&4&&(ge.checked=ge.__value===ne[2]),he&4&&(Q.checked=Q.__value===ne[2]),he&8&&ol(w,ne[3]),ne[2]==="gpt"?L?L.p(ne,he):(L=Ds(),L.c(),L.m(m,_e)):L&&(L.d(1),L=null),ne[4]&&ne[5]?z?z.p(ne,he):(z=Os(ne),z.c(),z.m(m,null)):z&&(z.d(1),z=null)},i:Jn,o:Jn,d(ne){ne&&Xe(c),L&&L.d(),z&&z.d(),V.r(),be=!1,di(Ke)}}}const nc="https://chatgpt.com/g/g-690f6217889c819191786ef16481f534-blockscape";function tc(o,c,f){let C="",k=!1,N="gpt",j="",m="",G=!1;const q=()=>{var F;return typeof navigator<"u"&&!!((F=navigator.clipboard)!=null&&F.writeText)};function re(F){const X=F||"[DOMAIN]",Se=k?"series":"map",pe=Zl.replaceAll("[DOMAIN NAME]",X).replaceAll("[DOMAIN]",X).replaceAll("[map|series]",Se).split(`
`),fe=`Generate a **blockscape ${Se}** for the domain of ${X}.`,te=pe.findIndex(we=>we.toLowerCase().includes("generate a **blockscape value")||we.toLowerCase().includes("generate a blockscape [map|series]")||we.toLowerCase().startsWith("generate a blockscape"));te>=0?pe[te]=fe:pe.unshift(fe);const le=k?`

User requested a series (return an array of models).`:"";return`${pe.join(`
`).trim()}${le}`}async function J(F){F.preventDefault();const X=C.trim();if(f(3,j=""),f(5,G=N!=="gpt"),!X){f(3,j="Add a domain to generate a prompt."),f(4,m="");return}if(N==="gpt"?f(4,m=`${k?"Create a series":"Create a map"} for ${X}`):(f(4,m=re(X)),f(5,G=!0)),!q()){f(3,j="Clipboard access is unavailable. Copy the prompt below."),f(5,G=!0);return}try{await navigator.clipboard.writeText(m),f(3,j=N==="gpt"?"Prompt copied. Open the Blockscape GPT link to paste it.":"Prompt copied to clipboard."),N==="gpt"&&f(5,G=!1)}catch(P){console.warn("[Blockscape] clipboard write failed",P),f(3,j="Copy failed. Use the prompt below."),f(5,G=!0)}}const de=[[]];function me(){C=this.value,f(0,C)}function Re(){k=this.checked,f(1,k)}function $(){N=this.__value,f(2,N)}function W(){N=this.__value,f(2,N)}function Z(){m=this.value,f(4,m)}return[C,k,N,j,m,G,J,me,Re,$,de,W,Z]}class ic extends Da{constructor(c){super(),Ba(this,c,tc,ec,Pa,{})}}const{document:Us}=tl;function ac(o){let c,f,C,k,N,j,m,G,q,re,J,de,me,Re,$,W,Z,F,X,Se,P,pe,fe,te,le,we,ge,ve,en,je,R,Q,Ve,Be,$e,qe,Ae,We,S,w,Ge,_e=`<script id="seed" type="application/json">${o[1]}<\/script>`,V,be,Ke,L,z,ne,he,pn,hn,un,De,On,Ye;return pn=new Yl({}),un=new ic({}),{c(){c=U("link"),f=oe(),C=U("div"),k=U("header"),N=U("div"),j=U("div"),m=U("div"),G=U("div"),G.innerHTML='<h1 class="sr-only">Blockscape</h1> <img class="blockscape-brand__logo" src="logos/blockscape-logo.svg" alt="Blockscape — landscape tile explorer" decoding="async"/> <a href="https://github.com/pwright/blockscape" target="_blank" class="pf-v5-c-button pf-m-plain" title="View on GitHub" aria-label="View Blockscape on GitHub"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"></path></svg></a>',q=oe(),re=U("div"),J=U("div"),de=U("button"),me=U("span"),me.textContent="Toggle search and edit tools",Re=oe(),$=U("span"),$.textContent="▾",W=oe(),Z=U("button"),Z.textContent="New",F=oe(),X=U("form"),X.innerHTML='<label class="sr-only" for="urlInput">Load JSON from URL</label> <input id="urlInput" name="modelUrl" class="pf-v5-c-form-control is-url" type="url" placeholder="Load JSON from URL…" autocomplete="additional-name"/> <button id="loadUrl" class="pf-v5-c-button pf-m-primary" type="submit">Load URL</button> <div id="urlHint" class="url-hint" aria-live="polite"></div>',Se=oe(),P=U("label"),P.innerHTML='<span>Open</span> <input id="file" type="file" accept=".bs,.json,.txt" multiple=""/>',pe=oe(),fe=U("button"),fe.textContent="Help",te=oe(),le=U("div"),we=U("div"),we.innerHTML='<label class="sr-only" for="search">Search tiles</label> <input id="search" class="pf-v5-c-form-control" type="text" placeholder="Search…"/> <div id="searchResults" class="search-results" role="listbox" aria-label="Search across all models" hidden=""></div>',ge=oe(),ve=U("button"),ve.textContent="Edit",en=oe(),je=U("button"),je.textContent="Share",Be=oe(),$e=U("div"),$e.innerHTML='<span class="legend-entry"><span class="legend-dot legend-dot--dep"></span> enables</span> <span class="legend-entry"><span class="legend-dot legend-dot--revdep"></span> dependents</span> <span class="legend-entry"><span class="legend-dot legend-dot--reused"></span> reused</span> <span class="legend-entry"><span class="legend-dot legend-dot--external"></span> external link</span>',qe=oe(),Ae=U("main"),Ae.innerHTML=`<div class="blockscape-content"><aside class="blockscape-sidebar" aria-label="Models"><div class="sidebar-heading">Models</div> <ul id="modelList" class="model-nav-list"></ul> <div class="model-actions"><button id="removeModel" class="pf-v5-c-button pf-m-tertiary" type="button" title="Remove selected model">Remove active</button> <button id="clear" class="pf-v5-c-button pf-m-tertiary" type="button">Clear selection</button></div> <div class="sidebar-heading sidebar-heading--sub">Portfolio</div> <ul id="modelSets" class="model-nav-list model-nav-list--sets"></ul></aside> <div class="blockscape-main"><section class="pf-v5-c-page__main-section blockscape-json-panel" hidden="" aria-label="Model source JSON editor"><p class="blockscape-json-panel__title">Paste / edit JSON for the <b>active</b> model (schema below)</p> <div class="muted">Schema: <code>{ id, title, abstract?, categories:[{id,title,items:[{id,name,logo?,external?:url,color?,deps:[]}}], links?:[{from,to}] }</code><br/>
            ...
            Cmd/Ctrl+V anywhere on the page to append clipboard JSON instantly.</div> <div class="blockscape-json-controls"><textarea id="jsonBox" class="pf-v5-c-form-control" aria-label="JSON editor for the active model"></textarea> <div class="blockscape-json-actions"><button id="copyJson" class="pf-v5-c-button pf-m-tertiary" type="button" title="Copy the current JSON to your clipboard">Copy</button> <button id="copySeries" class="pf-v5-c-button pf-m-tertiary" type="button" title="Copy every version in this series as an array">Copy series</button> <button id="pasteJson" class="pf-v5-c-button pf-m-tertiary" type="button" title="Paste clipboard JSON to replace the editor contents">Paste</button> <button id="appendFromBox" class="pf-v5-c-button pf-m-primary" type="button">Append model(s)</button> <button id="replaceActive" class="pf-v5-c-button pf-m-secondary" type="button">Replace active with
                JSON</button> <button id="createVersion" class="pf-v5-c-button pf-m-secondary" type="button" title="Create a new version from the current map">New version</button></div></div></section> <section class="pf-v5-c-page__main-section blockscape-main-section"><div id="app" aria-live="polite"></div></section></div></div>`,We=oe(),S=U("footer"),S.innerHTML='<div class="blockscape-footer__inner"><a href="https://pwright.github.io/backscape/" target="_blank" rel="noreferrer noopener">Old versions</a></div>',w=oe(),Ge=new rl(!1),V=oe(),be=Hs("svg"),Ke=oe(),L=U("div"),z=oe(),ne=U("div"),ne.innerHTML='<div class="item-preview__header"><span class="item-preview__title">Preview</span> <div class="item-preview__actions" hidden=""></div> <button type="button" class="item-preview__close" aria-label="Close preview">×</button></div> <div class="item-preview__body"><div class="item-preview__status">Right-click a tile to see related notes.</div></div>',he=oe(),Ms(pn.$$.fragment),hn=oe(),Ms(un.$$.fragment),Us.title="Blockscape — simple landscape-style tiles",y(c,"rel","icon"),y(c,"type","image/svg+xml"),y(c,"href","./favicon.svg"),y(G,"class","blockscape-brand"),y(me,"class","sr-only"),y($,"class","blockscape-toolbar__toggle-icon"),y($,"aria-hidden","true"),y(de,"class","pf-v5-c-button pf-m-plain blockscape-toolbar__toggle"),y(de,"type","button"),y(de,"aria-expanded",o[0]),y(de,"aria-controls","blockscapeHeaderExtras"),y(Z,"id","newPanelButton"),y(Z,"class","pf-v5-c-button pf-m-primary"),y(Z,"type","button"),y(Z,"title","Create something new"),y(X,"id","urlForm"),y(X,"class","blockscape-url-form"),y(X,"autocomplete","on"),X.noValidate=!0,y(P,"class","pf-v5-c-button pf-m-primary blockscape-file"),y(fe,"id","helpButton"),y(fe,"class","pf-v5-c-button pf-m-primary"),y(fe,"type","button"),y(fe,"title","Show keyboard shortcuts"),y(J,"class","blockscape-toolbar__primary"),y(we,"class","blockscape-search"),y(ve,"id","openInEditor"),y(ve,"class","pf-v5-c-button pf-m-secondary"),y(ve,"type","button"),y(ve,"title","Open current JSON in the editor"),y(je,"id","shareModel"),y(je,"class","pf-v5-c-button pf-m-secondary"),y(je,"type","button"),y(je,"title","Copy a shareable URL for this model"),y(le,"id","blockscapeHeaderExtras"),y(le,"class","blockscape-toolbar__extras"),le.hidden=R=!o[0],y(le,"aria-hidden",Q=!o[0]),y(re,"class","blockscape-toolbar__controls"),y(re,"data-expanded",Ve=o[0]?"true":"false"),y($e,"class","blockscape-legend"),y($e,"role","presentation"),y(m,"class","blockscape-toolbar"),y(j,"class","pf-v5-c-masthead__content"),y(N,"class","pf-v5-c-masthead pf-m-display-inline blockscape-masthead"),y(k,"class","pf-v5-c-page__header"),y(Ae,"class","pf-v5-c-page__main"),y(S,"class","pf-v5-c-page__footer blockscape-footer"),y(C,"class","pf-v5-c-page"),Ge.a=V,y(be,"id","overlay"),y(be,"class","svg-layer"),y(L,"id","tabTooltip"),y(L,"class","blockscape-tab-tooltip"),L.hidden=!0,y(L,"aria-hidden","true"),y(ne,"id","itemPreview"),y(ne,"class","item-preview"),ne.hidden=!0,y(ne,"aria-hidden","true")},m(ie,Ne){T(Us.head,c),on(ie,f,Ne),on(ie,C,Ne),T(C,k),T(k,N),T(N,j),T(j,m),T(m,G),T(m,q),T(m,re),T(re,J),T(J,de),T(de,me),T(de,Re),T(de,$),T(J,W),T(J,Z),T(J,F),T(J,X),T(J,Se),T(J,P),T(J,pe),T(J,fe),T(re,te),T(re,le),T(le,we),T(le,ge),T(le,ve),T(le,en),T(le,je),T(m,Be),T(m,$e),T(C,qe),T(C,Ae),T(C,We),T(C,S),on(ie,w,Ne),Ge.m(_e,ie,Ne),on(ie,V,Ne),on(ie,be,Ne),on(ie,Ke,Ne),on(ie,L,Ne),on(ie,z,Ne),on(ie,ne,Ne),on(ie,he,Ne),Na(pn,ie,Ne),on(ie,hn,Ne),Na(un,ie,Ne),De=!0,On||(Ye=bt(de,"click",o[2]),On=!0)},p(ie,[Ne]){(!De||Ne&1)&&y(de,"aria-expanded",ie[0]),(!De||Ne&1&&R!==(R=!ie[0]))&&(le.hidden=R),(!De||Ne&1&&Q!==(Q=!ie[0]))&&y(le,"aria-hidden",Q),(!De||Ne&1&&Ve!==(Ve=ie[0]?"true":"false"))&&y(re,"data-expanded",Ve)},i(ie){De||(La(pn.$$.fragment,ie),La(un.$$.fragment,ie),De=!0)},o(ie){Ns(pn.$$.fragment,ie),Ns(un.$$.fragment,ie),De=!1},d(ie){ie&&(Xe(f),Xe(C),Xe(w),Ge.d(),Xe(V),Xe(be),Xe(Ke),Xe(L),Xe(z),Xe(ne),Xe(he),Xe(hn)),Xe(c),Ma(pn,ie),Ma(un,ie),On=!1,Ye()}}}function sc(o,c,f){const C=`
  {
  "id": "blockscape",
...
}`;let k=!1;const N=()=>{if(f(0,k=!k),!k){const j=document.getElementById("search");j&&j.value&&(j.value="",j.dispatchEvent(new Event("input",{bubbles:!0})))}};return cl(()=>{Ql()}),[k,C,N]}class oc extends Da{constructor(c){super(),Ba(this,c,sc,ac,Pa,{})}}const rc=document.getElementById("root");new oc({target:rc});
