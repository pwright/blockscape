...
- You can deep-link to a specific local model by appending its relative path: `http://127.0.0.1:4173/server/path/to/file.bs` will auto-load and auto-reload `~/blockscape/path/to/file.bs` on refresh.
